...
THREE.Color.prototype = {
    ...
    setHSV: function(a, b, c) {
        var d, e, f;
        0 === c ? this.r = this.g = this.b = 0 : (d = Math.floor(6 * a),
        e = 6 * a - d,
        a = c * (1 - b),
        f = c * (1 - b * e),
        b = c * (1 - b * (1 - e)),
        0 === d ? (this.r = c,
        this.g = b,
        this.b = a) : 1 === d ? (this.r = f,
        this.g = c,
        this.b = a) : 2 === d ? (this.r = a,
        this.g = c,
        this.b = b) : 3 === d ? (this.r = a,
        this.g = f,
        this.b = c) : 4 === d ? (this.r = b,
        this.g = a,
        this.b = c) : 5 === d && (this.r = c,
        this.g = a,
        this.b = f));
        return this
    },
...
THREE.Quaternion.prototype = {
    ...
    setFromEuler: function(a, b) {
        var c = Math.cos(a.x / 2)
          ...
          , g = Math.sin(a.y / 2)
          , i = Math.sin(a.z / 2);
        void 0 === b || "XYZ" === b ? (this.x = f * d * e + c * g * i,
        this.y = c * g * e - f * d * i,
        this.z = c * d * i + f * g * e,
        this.w = c * d * e - f * g * i) : "YXZ" === b ? (this.x = f * d * e + c * g * i,
        this.y = c * g * e - f * d * i,
        this.z = c * d * i - f * g * e,
        this.w = c * d * e + f * g * i) : "ZXY" === b ? (this.x = f * d * e - c * g * i,
        this.y = c * g * e + f * d * i,
        this.z = c * d * i + f * g * e,
        this.w = c * d * e - f * g * i) : "ZYX" === b ? (this.x = f * d * e - c * g * i,
        this.y = c * g * e + f * d * i,
        this.z = c * d * i - f * g * e,
        this.w = c * d * e + f * g * i) : "YZX" === b ? (this.x = f * d * e + c * g * i,
        this.y = c * g * e + f * d * i,
        this.z = c * d * i - f * g * e,
        this.w = c * d * e - f * g * i) : "XZY" === b && (this.x = f * d * e - c * g * i,
        this.y = c * g * e - f * d * i,
        this.z = c * d * i + f * g * e,
        this.w = c * d * e + f * g * i);
        return this
    ...
    setFromRotationMatrix: function(a) {
        ...
        this.x = 0.25 * c,
        this.y = (a + e) / c,
        this.z = (d + i) / c) : f > b ? (c = 2 * Math.sqrt(1 + f - c - b),
        this.w = (d - i) / c,
        this.x = (a + e) / c,
        this.y = 0.25 * c,
        this.z = (g + h) / c) : (c = 2 * Math.sqrt(1 + b - c - f),
        this.w = (e - a) / c,
        this.x = (d + i) / c,
        this.y = (g + h) / c,
        this.z = 0.25 * c);
...
THREE.Vector3.prototype = {
    ...
    applyAxisAngle: function(a, b) {
        var c = THREE.Vector3.__q1.setFromAxisAngle(a, b);
        this.applyQuaternion(c);
        return this
    },
    divide: function(a) {
    ...
    setEulerFromRotationMatrix: function(a, b) {
        ...
        this.z = Math.atan2(-f, e)) : (this.x = Math.atan2(m, h),
        this.z = 0)) : "YXZ" === b ? (this.x = Math.asin(-c(k)),
        0.99999 > Math.abs(k) ? (this.y = Math.atan2(g, d),
        this.z = Math.atan2(i, h)) : (this.y = Math.atan2(-l, e),
        this.z = 0)) : "ZXY" === b ? (this.x = Math.asin(c(m)),
        0.99999 > Math.abs(m) ? (this.y = Math.atan2(-l, d),
        this.z = Math.atan2(-f, h)) : (this.y = 0,
        this.z = Math.atan2(i, e))) : "ZYX" === b ? (this.y = Math.asin(-c(l)),
        0.99999 > Math.abs(l) ? (this.x = Math.atan2(m, d),
        this.z = Math.atan2(i, e)) : (this.x = 0,
        this.z = Math.atan2(-f, h))) : "YZX" === b ? (this.z = Math.asin(c(i)),
        0.99999 > Math.abs(i) ? (this.x = Math.atan2(-k, h),
        this.y = Math.atan2(-l, e)) : (this.x = 0,
        this.y = Math.atan2(g, d))) : "XZY" === b && (this.z = Math.asin(-c(f)),
        0.99999 > Math.abs(f) ? (this.x = Math.atan2(m, h),
...
THREE.Vector4.prototype = {
    ...
    setAxisAngleFromRotationMatrix: function(a) {
        ...
        if (0.01 > Math.abs(d - g) && 0.01 > Math.abs(f - c) && 0.01 > Math.abs(h - b)) {
            if (0.1 > Math.abs(d + g) && 0.1 > Math.abs(f + c) && 0.1 > Math.abs(h + b) && 0.1 > Math.abs(e + i + k - 3))
            ...
            c = d / b,
            d = f / b) : i > k ? 0.01 > i ? (b = 0.707106781,
            c = 0,
            d = 0.707106781) : (c = Math.sqrt(i),
            b = d / c,
            d = h / c) : 0.01 > k ? (c = b = 0.707106781,
            d = 0) : (d = Math.sqrt(k),
            b = f / d,
            c = h / d);
            this.set(b, c, d, a);
...
THREE.Box3.prototype = {
    ...
    distanceToPoint: function(a) {
        return THREE.Box3.__v1.copy(a).clamp(this.min, this.max).sub(a).length()
    },
    ...
    transform: function(a) {
        a = [THREE.Box3.__v0.set(this.min.x, this.min.y, this.min.z).applyMatrix4(a), THREE.Box3.__v0.set(this.min.x, this.min.y, this.min.z).applyMatrix4(a), THREE.Box3.__v1.set(this.min.x, this.min.y, this.max.z).applyMatrix4(a), THREE.Box3.__v2.set(this.min.x, this.max.y, this.min.z).applyMatrix4(a), THREE.Box3.__v3.set(this.min.x, this.max.y, this.max.z).applyMatrix4(a), THREE.Box3.__v4.set(this.max.x, this.min.y, this.min.z).applyMatrix4(a), THREE.Box3.__v5.set(this.max.x, this.min.y, this.max.z).applyMatrix4(a), THREE.Box3.__v6.set(this.max.x, this.max.y, this.min.z).applyMatrix4(a), THREE.Box3.__v7.set(this.max.x, this.max.y, this.max.z).applyMatrix4(a)];
        this.makeEmpty();
...
THREE.Matrix4.prototype = {
    ...
    determinant: function() {
        var a = this.elements
          ...
          , m = a[10]
          , n = a[14];
        return a[3] * (+e * i * l - d * h * l - e * g * m + c * h * m + d * g * n - c * i * n) + a[7] * (+b * i * n - b * h * m + e * f * m - d * f * n + d * h * k - e * i * k) + a[11] * (+b * h * l - b * g * n - e * f * l + c * f * n + e * g * k - c * h * k) + a[15] * (-d * g * k - b * i * l + b * g * m + d * f * l - c * f * m + c * i * k)
    },
    transpose: function() {
    ...
    getInverse: function(a, b) {
        ...
        c[8] = g * m * t - i * l * t + i * k * x - f * m * x - g * k * z + f * l * z;
        ...
        c[11] = g * k * s - f * l * s - g * h * t + e * l * t + f * h * x - e * k * x;
...
THREE.Frustum.prototype = {
    ...
    setFromMatrix: function(a) {
        ...
        b[1].setComponents(f + a, k + g, r + l, c + p).normalize();
...
THREE.Plane.prototype = {
    ...
    intersectLine: function(a, b, c) {
        ...
        if (0 == d) {
            ...
            return d = -(a.dot(this.normal) + this.constant) / d,
            0 > d || 1 < d ? void 0 : c.copy(b).multiplyScalar(d).add(a)
    },
    coplanarPoint: function(a) {
        return (a || new THREE.Vector3).copy(this.normal).multiplyScalar(-this.constant)
    },
    transform: function(a, b) {
        var b = b || (new THREE.Matrix3).getInverse(a).transpose()
          , c = THREE.Plane.__v1.copy(this.normal).applyMatrix3(b)
      ...
      , i = function(g, i, h) {
        if (g instanceof a.Particle) {
            ...
            for (var I = 0, H = n.faces.length; I < H; I++) {
                ...
                if (void 0 !== s) {
                    d.setFromNormalAndCoplanarPoint(D.normal, r[D.a]);
                    var y = c.distanceToPlane(d);
                    if (!(Math.abs(y) < v) && !(0 > y)) {
                        s = s.side;
                        if (s !== a.DoubleSide && (t = c.direction.dot(d.normal),
                        !(s === a.FrontSide ? 0 > t : 0 < t)))
                            continue;
                        if (!(y < i.near || y > i.far)) {
                            e = c.at(y, e);
                            if (D instanceof a.Face3) {
                                ...
                                t = r[D.b],
                                x = r[D.c],
                                !a.Triangle.containsPoint(e, s, t, x))
                                    continue
                                ...
                                x = r[D.c],
                                z = r[D.d],
                                !a.Triangle.containsPoint(e, s, t, z) && !a.Triangle.containsPoint(e, t, x, z))
                                    continue
                            } else
...
THREE.Projector = function() {
    ...
    this.projectScene = function(g, i, m, Ja) {
            ...
            for (var c = 0, d = b.children.length; c < d; c++) {
                ...
                if (!1 !== f.visible) {
                    if (f instanceof THREE.Light)
                        ...
                        if (!1 === f.frustumCulled || !0 === Oa.intersectsObject(f))
                            e = a(),
                            e.object = f,
                            null !== f.renderDepth ? e.z = f.renderDepth : (W.copy(f.matrixWorld.getPosition()),
                            W.applyProjection(aa),
                            e.z = W.z),
                            G.objects.push(e)
                    } else
        ...
        for (m = G.objects.length; g < m; g++)
            if (pa = G.objects[g].object,
            ba = pa.matrixWorld,
            k = 0,
            pa instanceof THREE.Mesh) {
                gb = pa.geometry;
                Ra = gb.vertices;
                hb = gb.faces;
                gb = gb.faceVertexUvs;
                ...
                wa = 0;
                for (Ta = Ra.length; wa < Ta; wa++)
                    h = b(),
                    h.positionWorld.copy(Ra[wa]).applyMatrix4(ba),
                    h.positionScreen.copy(h.positionWorld).applyMatrix4(aa),
                    h.positionScreen.x /= h.positionScreen.w,
                    h.positionScreen.y /= h.positionScreen.w,
                    h.positionScreen.z /= h.positionScreen.w,
                    h.visible = !(-1 > h.positionScreen.x || 1 < h.positionScreen.x || -1 > h.positionScreen.y || 1 < h.positionScreen.y || -1 > h.positionScreen.z || 1 < h.positionScreen.z);
                Ra = 0;
                for (wa = hb.length; Ra < wa; Ra++) {
                    ...
                    if (void 0 !== Ua) {
                        ...
                        if (Ta instanceof THREE.Face3)
                            ...
                            ra = l[Ta.b],
                            Z = l[Ta.c],
                            K[0] = ia.positionScreen,
                            K[1] = ra.positionScreen,
                            K[2] = Z.positionScreen,
                            !0 === ia.visible || !0 === ra.visible || !0 === Z.visible || X.isIntersectionBox(B.setFromPoints(K)))
                                if (ma = 0 > (Z.positionScreen.x - ia.positionScreen.x) * (ra.positionScreen.y - ia.positionScreen.y) - (Z.positionScreen.y - ia.positionScreen.y) * (ra.positionScreen.x - ia.positionScreen.x),
                                ga === THREE.DoubleSide || ma === (ga === THREE.FrontSide))
                                    r === q ? (Ea = new THREE.RenderableFace3,
                                    p.push(Ea),
                                    q++,
                                    r++,
                                    n = Ea) : n = p[r++],
                            ...
                            Z = l[Ta.c],
                            Ea = l[Ta.d],
                            L[0] = ia.positionScreen,
                            L[1] = ra.positionScreen,
                            L[2] = Z.positionScreen,
                            L[3] = Ea.positionScreen,
                            !0 === ia.visible || !0 === ra.visible || !0 === Z.visible || !0 === Ea.visible || X.isIntersectionBox(B.setFromPoints(L)))
                                if (ma = 0 > (Ea.positionScreen.x - ia.positionScreen.x) * (ra.positionScreen.y - ia.positionScreen.y) - (Ea.positionScreen.y - ia.positionScreen.y) * (ra.positionScreen.x - ia.positionScreen.x) || 0 > (ra.positionScreen.x - Z.positionScreen.x) * (Ea.positionScreen.y - Z.positionScreen.y) - (ra.positionScreen.y - Z.positionScreen.y) * (Ea.positionScreen.x - Z.positionScreen.x),
                                ga === THREE.DoubleSide || ma === (ga === THREE.FrontSide)) {
                                    if (s === x) {
                        ...
                        Z = Ta.vertexNormals;
                        ia = 0;
                        for (ra = Z.length; ia < ra; ia++)
                            Ea = n.vertexNormalsModel[ia],
                            Ea.copy(Z[ia]),
                            !1 === ma && (ga === THREE.BackSide || ga === THREE.DoubleSide) && Ea.negate(),
                            Ea.applyMatrix3(J).normalize(),
                            n.vertexNormalsModelView[ia].copy(Ea).applyMatrix3(ha);
                ...
                for (Ta = Ra.length; wa < Ta; wa++)
                    ia = b(),
                    ia.positionScreen.copy(Ra[wa]).applyMatrix4(xa),
                    0 < (wa + 1) % hb || (ra = l[k - 2],
                    M.copy(ia.positionScreen),
                    fa.copy(ra.positionScreen),
                    !0 === d(M, fa) && (M.multiplyScalar(1 / M.w),
                    fa.multiplyScalar(1 / fa.w),
                    v === H ? (gb = new THREE.RenderableLine,
                    I.push(gb),
                    H++,
                    v++,
                    z = gb) : z = I[v++],
                    z.v1.positionScreen.copy(M),
                    z.v2.positionScreen.copy(fa),
                    z.z = Math.max(M.z, fa.z),
                    z.material = pa.material,
                    G.elements.push(z)))
            }
        g = 0;
        for (m = G.sprites.length; g < m; g++)
            pa = G.sprites[g].object,
            ba = pa.matrixWorld,
            pa instanceof THREE.Particle && (A.set(ba.elements[12], ba.elements[13], ba.elements[14], 1),
            A.applyMatrix4(aa),
            A.z /= A.w,
            0 < A.z && 1 > A.z && (y === E ? (ma = new THREE.RenderableParticle,
            F.push(ma),
            E++,
            y++,
            D = ma) : D = F[y++],
            ...
            D.y = A.y / A.w,
            D.z = A.z,
            D.rotation = pa.rotation.z,
            D.scale.x = pa.scale.x * Math.abs(D.x - (A.x + i.projectionMatrix.elements[0]) / (A.w + i.projectionMatrix.elements[12])),
            D.scale.y = pa.scale.y * Math.abs(D.y - (A.y + i.projectionMatrix.elements[5]) / (A.w + i.projectionMatrix.elements[13])),
            D.material = pa.material,
            G.elements.push(D)));
...
THREE.Geometry.prototype = {
    ...
    computeVertexNormals: function(a) {
        ...
        if (a) {
            ...
            for (c = this.faces.length; b < c; b++)
                ...
                e[d.a].add(h),
                e[d.b].add(h),
                e[d.c].add(h)) : d instanceof THREE.Face4 && (a = this.vertices[d.a],
                f = this.vertices[d.b],
                g = this.vertices[d.c],
                i = this.vertices[d.d],
                l.subVectors(i, f),
    ...
    computeTangents: function() {
        ...
        for (c = this.faces.length; b < c; b++) {
            ...
            for (d = 0; d < f.vertexNormals.length; d++)
                ...
                y = F[e],
                A.copy(y),
                A.sub(B.multiplyScalar(B.dot(y))).normalize(),
                X.crossVectors(f.vertexNormals[d], y),
                e = X.dot(E[e]),
                e = 0 > e ? -1 : 1,
    ...
    mergeVertices: function() {
        ...
        for (g = this.faces.length; f < g; f++)
            ...
            a instanceof THREE.Face3) {
                ...
                d = -1;
                for (h = 0; 4 > h; h++)
                    i[h] == i[(h + 1) % 4] && (0 <= d && e.push(f),
                    d = h);
                if (0 <= d) {
                    i.splice(d, 1);
                    var l = new THREE.Face3(i[0],i[1],i[2],a.normal,a.color,a.materialIndex);
                    i = 0;
                    for (h = this.faceVertexUvs.length; i < h; i++)
                        (k = this.faceVertexUvs[i][f]) && k.splice(d, 1);
        ...
        for (f = e.length - 1; 0 <= f; f--) {
            ...
            i = 0;
            for (h = this.faceVertexUvs.length; i < h; i++)
                this.faceVertexUvs[i].splice(f, 1)
        }
    ...
    clone: function() {
        ...
        c = 0;
        for (d = b.length; c < d; c++) {
            for (var e = b[c], f = [], g = 0, i = e.length; g < i; g++)
...
THREE.BufferGeometry.prototype = {
    ...
    computeTangents: function() {
        ...
        if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv)
            ...
            for (var i = this.attributes.tangent.array, h = [], k = [], g = 0; g < f; g++)
                h[g] = new THREE.Vector3,
            ...
            for (W = K.length; G < W; ++G) {
                ...
                for (E += A; F < E; F += 3)
                    ...
                    v = y - v,
                    y = 1 / (I * v - z * H),
                    f.set((v * r - H * l) * y, (v * p - H * m) * y, (v * q - H * n) * y),
                    g.set((I * l - z * r) * y, (I * m - z * p) * y, (I * n - z * q) * y),
                    h[A].add(f),
                    h[X].add(f),
                    h[B].add(f),
                    k[A].add(g),
...
THREE.Loader.prototype = {
    ...
    createMaterial: function(a, b) {
        ...
        function e(a, e, f, i, h, k, s) {
            var t = f.toLowerCase().endsWith(".dds")
              , x = b + "/" + f;
            if (t) {
            ...
            a[e].sourceFile = f;
            i && (a[e].repeat.set(i[0], i[1]),
            1 !== i[0] && (a[e].wrapS = THREE.RepeatWrapping),
            1 !== i[1] && (a[e].wrapT = THREE.RepeatWrapping));
        ...
        a.mapDiffuse && b && e(h, "map", a.mapDiffuse, a.mapDiffuseRepeat, a.mapDiffuseOffset, a.mapDiffuseWrap, a.mapDiffuseAnisotropy);
        ...
        a.mapSpecular && b && e(h, "specularMap", a.mapSpecular, a.mapSpecularRepeat, a.mapSpecularOffset, a.mapSpecularWrap, a.mapSpecularAnisotropy);
        a.mapBumpScale && (h.bumpScale = a.mapBumpScale);
        a.mapNormal ? (i = THREE.ShaderLib.normalmap,
        ...
        k.enableAO.value = !0),
        k.uDiffuseColor.value.setHex(h.color),
        k.uSpecularColor.value.setHex(h.specular),
        k.uAmbientColor.value.setHex(h.ambient),
        k.uShininess.value = h.shininess,
        void 0 !== h.opacity && (k.uOpacity.value = h.opacity),
...
THREE.JSONLoader.prototype.createModel = function(a, b, c) {
    ...
    for (k = v.length; h < k; ) {
        ...
        if (f)
            for (f = 0; f < D; f++)
                ...
                z = t[2 * r],
                r = t[2 * r + 1],
                d.faceUvs[f][i] = new THREE.Vector2(z,r);
        if (g)
            for (f = 0; f < D; f++) {
                t = a.uvs[f];
                x = [];
    ...
    if (a.skinWeights) {
        ...
        for (k = a.skinWeights.length; h < k; h += 2)
            v = a.skinWeights[h],
            I = a.skinWeights[h + 1],
            d.skinWeights.push(new THREE.Vector4(v,I,0,0))
    }
    if (a.skinIndices) {
        h = 0;
        for (k = a.skinIndices.length; h < k; h += 2)
            v = a.skinIndices[h],
            I = a.skinIndices[h + 1],
            d.skinIndices.push(new THREE.Vector4(v,I,0,0))
    }
    d.bones = a.bones;
    ...
    if (void 0 !== a.morphColors) {
        ...
        for (k = a.morphColors.length; h < k; h++) {
            ...
            e = 0;
            for (v = H.length; e < v; e += 3)
                D = new THREE.Color(16755200),
                D.setRGB(H[e], H[e + 1], H[e + 2]),
                I.push(D)
        }
    }
    d.computeCentroids();
...
THREE.SceneLoader.prototype.parse = function(a, b, c) {
        ...
        for (q in b)
            if (void 0 === y.objects[q]) {
                ...
                if (s.type && s.type in l.hierarchyHandlerMap) {
                    ...
                    if (n = y.geometries[s.geometry]) {
                        ...
                        if (r instanceof THREE.MeshFaceMaterial)
                            for (e = 0; e < r.materials.length; e++)
                                v = v || r.materials[e]instanceof THREE.ShaderMaterial;
                        v && n.computeTangents();
                        s.skin ? v = new THREE.SkinnedMesh(n,r) : s.morph ? (v = new THREE.MorphAnimMesh(n,r),
                        void 0 !== s.duration && (v.duration = s.duration),
                        void 0 !== s.time && (v.time = s.time),
                        void 0 !== s.mirroredLoop && (v.mirroredLoop = s.mirroredLoop),
                        r.morphNormals && n.computeMorphNormals()) : v = new THREE.Mesh(n,r);
                        v.name = q;
                        c ? (v.matrixAutoUpdate = !1,
                        v.matrix.set(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13], c[14], c[15])) : (v.position.set(g[0], g[1], g[2]),
                        m ? (v.quaternion.set(m[0], m[1], m[2], m[3]),
                        v.useQuaternion = !0) : v.rotation.set(h[0], h[1], h[2]),
                        v.scale.set(k[0], k[1], k[2]));
                        v.visible = s.visible;
                    ...
                    "DirectionalLight" === s.type || "PointLight" === s.type || "AmbientLight" === s.type ? (x = void 0 !== s.color ? s.color : 16777215,
                    z = void 0 !== s.intensity ? s.intensity : 1,
                    "DirectionalLight" === s.type ? (g = s.direction,
                    t = new THREE.DirectionalLight(x,z),
                    t.position.set(g[0], g[1], g[2]),
                    s.target && (F.push({
                        object: t,
                        targetName: s.target
                    }),
                    t.target = null)) : "PointLight" === s.type ? (g = s.position,
                    e = s.distance,
                    t = new THREE.PointLight(x,z,e),
                    t.position.set(g[0], g[1], g[2])) : "AmbientLight" === s.type && (t = new THREE.AmbientLight(x)),
                    a.add(t),
                    t.name = q,
                    y.lights[q] = t,
                    y.objects[q] = t) : "PerspectiveCamera" === s.type || "OrthographicCamera" === s.type ? ("PerspectiveCamera" === s.type ? p = new THREE.PerspectiveCamera(s.fov,s.aspect,s.near,s.far) : "OrthographicCamera" === s.type && (p = new THREE.OrthographicCamera(s.left,s.right,s.top,s.bottom,s.near,s.far)),
                    g = s.position,
                    p.position.set(g[0], g[1], g[2]),
                    a.add(p),
                    p.name = q,
                    y.cameras[q] = p,
                    y.objects[q] = p) : (g = s.position,
                    h = s.rotation,
                    k = s.scale,
                    m = s.quaternion,
                    v = new THREE.Object3D,
                    v.name = q,
                    v.position.set(g[0], g[1], g[2]),
                    m ? (v.quaternion.set(m[0], m[1], m[2], m[3]),
                    v.useQuaternion = !0) : v.rotation.set(h[0], h[1], h[2]),
                    v.scale.set(k[0], k[1], k[2]),
                    v.visible = void 0 !== s.visible ? s.visible : !1,
                    a.add(v),
                    y.objects[q] = v,
                    y.empties[q] = v);
                if (v) {
                    if (void 0 !== s.properties)
                        for (var D in s.properties)
                            v.properties[D] = s.properties[D];
                    if (void 0 !== s.groups)
                        for (e = 0; e < s.groups.length; e++)
                            g = s.groups[e],
                            void 0 === y.groups[g] && (y.groups[g] = []),
                            y.groups[g].push(q);
    ...
    function i(a, b, c, d) {
        return function(f) {
            ...
            h ? (f.quaternion.set(h[0], h[1], h[2], h[3]),
            f.useQuaternion = !0) : f.rotation.set(i[0], i[1], i[2]);
    ...
    if (E.transform && (G = E.transform.position,
    a = E.transform.rotation,
    c = E.transform.scale,
    G && y.scene.position.set(G[0], G[1], G[2]),
    a && y.scene.rotation.set(a[0], a[1], a[2]),
    c && y.scene.scale.set(c[0], c[1], c[2]),
    G || a || c))
        y.scene.updateMatrix(),
        y.scene.updateMatrixWorld();
    G = function(a) {
        return function() {
            I -= a;
            k();
    ...
    for (var W in E.fogs)
        a = E.fogs[W],
        "linear" === a.type ? q = new THREE.Fog(0,a.near,a.far) : "exp2" === a.type && (q = new THREE.FogExp2(0,a.density)),
        a = a.color,
        q.color.setRGB(a[0], a[1], a[2]),
        y.fogs[W] = q;
    for (var A in E.geometries)
        q = E.geometries[A],
        q.type in this.geometryHandlerMap && (v += 1,
        l.onLoadStart());
    for (var X in E.objects)
        q = E.objects[X],
        q.type && q.type in this.hierarchyHandlerMap && (v += 1,
        l.onLoadStart());
    H = v;
    for (A in E.geometries)
        if (q = E.geometries[A],
        "cube" === q.type)
            n = new THREE.CubeGeometry(q.width,q.height,q.depth,q.widthSegments,q.heightSegments,q.depthSegments),
            y.geometries[A] = n;
        else if ("plane" === q.type)
            n = new THREE.PlaneGeometry(q.width,q.height,q.widthSegments,q.heightSegments),
            y.geometries[A] = n;
        else if ("sphere" === q.type)
            n = new THREE.SphereGeometry(q.radius,q.widthSegments,q.heightSegments),
            y.geometries[A] = n;
        else if ("cylinder" === q.type)
            n = new THREE.CylinderGeometry(q.topRad,q.botRad,q.height,q.radSegs,q.heightSegs),
            y.geometries[A] = n;
        else if ("torus" === q.type)
            n = new THREE.TorusGeometry(q.radius,q.tube,q.segmentsR,q.segmentsT),
            y.geometries[A] = n;
        else if ("icosahedron" === q.type)
            n = new THREE.IcosahedronGeometry(q.radius,q.subdivisions),
            y.geometries[A] = n;
        else if (q.type in this.geometryHandlerMap) {
            X = {};
            for (s in q)
                "type" !== s && "url" !== s && (X[s] = q[s]);
            this.geometryHandlerMap[q.type].loaderObject.load(d(q.url, E.urlBaseType), g(A), X)
        } else
            "embedded" === q.type && (X = E.embeds[q.id],
            X.metadata = E.metadata,
            X && this.geometryHandlerMap.ascii.loaderObject.createModel(X, h(A), ""));
    for (var B in E.textures)
        if (A = E.textures[B],
        A.url instanceof Array) {
            I += A.url.length;
            for (s = 0; s < A.url.length; s++)
                l.onLoadStart()
        } else
            I += 1,
            l.onLoadStart();
    ...
    for (B in E.textures) {
        ...
        if (A.url instanceof Array) {
            ...
            s = A.url.toLowerCase().endsWith(".dds"),
            X = d(A.url, E.urlBaseType),
            q = G(1),
            s = s ? THREE.ImageUtils.loadCompressedTexture(X, A.mapping, q) : THREE.ImageUtils.loadTexture(X, A.mapping, q),
            void 0 !== THREE[A.minFilter] && (s.minFilter = THREE[A.minFilter]),
            void 0 !== THREE[A.magFilter] && (s.magFilter = THREE[A.magFilter]),
            A.anisotropy && (s.anisotropy = A.anisotropy),
            A.repeat && (s.repeat.set(A.repeat[0], A.repeat[1]),
            1 !== A.repeat[0] && (s.wrapS = THREE.RepeatWrapping),
            1 !== A.repeat[1] && (s.wrapT = THREE.RepeatWrapping)),
            A.offset && s.offset.set(A.offset[0], A.offset[1]),
            A.wrap && (X = {
                repeat: THREE.RepeatWrapping,
                mirror: THREE.MirroredRepeatWrapping
            },
            void 0 !== X[A.wrap[0]] && (s.wrapS = X[A.wrap[0]]),
            void 0 !== X[A.wrap[1]] && (s.wrapT = X[A.wrap[1]]));
        y.textures[B] = s
    }
    var K, L;
    for (K in E.materials) {
        B = E.materials[K];
        for (L in B.parameters)
            "envMap" === L || "map" === L || "lightMap" === L || "bumpMap" === L ? B.parameters[L] = y.textures[B.parameters[L]] : "shading" === L ? B.parameters[L] = "flat" === B.parameters[L] ? THREE.FlatShading : THREE.SmoothShading : "side" === L ? B.parameters[L] = "double" == B.parameters[L] ? THREE.DoubleSide : "back" == B.parameters[L] ? THREE.BackSide : THREE.FrontSide : "blending" === L ? B.parameters[L] = B.parameters[L]in THREE ? THREE[B.parameters[L]] : THREE.NormalBlending : "combine" === L ? B.parameters[L] = B.parameters[L]in THREE ? THREE[B.parameters[L]] : THREE.MultiplyOperation : "vertexColors" === L ? "face" == B.parameters[L] ? B.parameters[L] = THREE.FaceColors : B.parameters[L] && (B.parameters[L] = THREE.VertexColors) : "wrapRGB" === L && (G = B.parameters[L],
            B.parameters[L] = new THREE.Vector3(G[0],G[1],G[2]));
        void 0 !== B.parameters.opacity && 1 > B.parameters.opacity && (B.parameters.transparent = !0);
        B.parameters.normalMap ? (G = THREE.ShaderLib.normalmap,
        A = THREE.UniformsUtils.clone(G.uniforms),
        s = B.parameters.color,
        X = B.parameters.specular,
        q = B.parameters.ambient,
        W = B.parameters.shininess,
        A.tNormal.value = y.textures[B.parameters.normalMap],
        B.parameters.normalScale && A.uNormalScale.value.set(B.parameters.normalScale[0], B.parameters.normalScale[1]),
        B.parameters.map && (A.tDiffuse.value = B.parameters.map,
        A.enableDiffuse.value = !0),
        B.parameters.envMap && (A.tCube.value = B.parameters.envMap,
        A.enableReflection.value = !0,
        A.uReflectivity.value = B.parameters.reflectivity),
        B.parameters.lightMap && (A.tAO.value = B.parameters.lightMap,
        A.enableAO.value = !0),
        B.parameters.specularMap && (A.tSpecular.value = y.textures[B.parameters.specularMap],
        A.enableSpecular.value = !0),
        B.parameters.displacementMap && (A.tDisplacement.value = y.textures[B.parameters.displacementMap],
        A.enableDisplacement.value = !0,
        A.uDisplacementBias.value = B.parameters.displacementBias,
        A.uDisplacementScale.value = B.parameters.displacementScale),
        A.uDiffuseColor.value.setHex(s),
        A.uSpecularColor.value.setHex(X),
        A.uAmbientColor.value.setHex(q),
        A.uShininess.value = W,
        B.parameters.opacity && (A.uOpacity.value = B.parameters.opacity),
    ...
    for (K in E.materials)
        if (B = E.materials[K],
        B.parameters.materials) {
            L = [];
            for (s = 0; s < B.parameters.materials.length; s++)
                L.push(y.materials[B.parameters.materials[s]]);
...
THREE.CanvasRenderer = function(a) {
    ...
    function c(a) {
        z !== a && (a === THREE.NormalBlending ? q.globalCompositeOperation = "source-over" : a === THREE.AdditiveBlending ? q.globalCompositeOperation = "lighter" : a === THREE.SubtractiveBlending && (q.globalCompositeOperation = "darker"),
        z = a)
    }
    function d(a) {
    ...
    var a = a || {}, f = this, g, i, h, k = new THREE.Projector, l = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"), m, n, r, p, q = l.getContext("2d"), s = new THREE.Color(0), t = 0, x = 1, z = 0, v = null, I = null, H = null, D = null, y = null, F, E, G, W, A = new THREE.RenderableVertex, X = new THREE.RenderableVertex, B, K, L, U, aa, ba, xa, J, ha, ua, Oa, M, fa = new THREE.Color, Da = new THREE.Color, Aa = new THREE.Color, Ia = new THREE.Color, Ja = new THREE.Color, ma = new THREE.Color, wa = new THREE.Color, Ta = new THREE.Color, Ra = {}, ia = {}, ra, ga, Z, pa, gb, hb, Ea, yb, Cb, Lb, Ua = new THREE.Box2, na = new THREE.Box2, Ya = new THREE.Box2, Db = !1, nb = new THREE.Color, kc = new THREE.Color, Mb = new THREE.Color, ib = new THREE.Vector3, zb, Ob, rc, ob, Fa, sb, pb = 16;
    ...
    this.clear = function() {
        ...
        !1 === na.empty() && (na.intersect(Ua),
        na.expandByScalar(2),
        1 > t && q.clearRect(na.min.x | 0, na.min.y | 0, na.max.x - na.min.x | 0, na.max.y - na.min.y | 0),
        0 < t && (c(THREE.NormalBlending),
        b(1),
        e("rgba(" + Math.floor(255 * s.r) + "," + Math.floor(255 * s.g) + "," + Math.floor(255 * s.b) + "," + t + ")"),
        q.fillRect(na.min.x | 0, na.min.y | 0, na.max.x - na.min.x | 0, na.max.y - na.min.y | 0)),
        na.makeEmpty())
    }
    ;
    this.render = function(a, l) {
        function n(a, b, c) {
            for (var d = 0, e = h.length; d < e; d++) {
                ...
                if (f instanceof THREE.DirectionalLight) {
                    var g = f.matrixWorld.getPosition().normalize()
                      , j = b.dot(g);
                    0 >= j || (j *= f.intensity,
                    c.add(Ta.multiplyScalar(j)))
                } else
                    f instanceof THREE.PointLight && (g = f.matrixWorld.getPosition(),
                    j = b.dot(ib.subVectors(g, a).normalize()),
        ...
        function m(a, d, e, g, j, i, h, Y) {
            ...
            s(B, K, L, U, aa, ba);
            (Y instanceof THREE.MeshLambertMaterial || Y instanceof THREE.MeshPhongMaterial) && null === Y.map && null === Y.map ? (ma.copy(Y.color),
            wa.copy(Y.emissive),
            Y.vertexColors === THREE.FaceColors && ma.multiply(h.color),
            !0 === Db ? !1 === Y.wireframe && Y.shading == THREE.SmoothShading && 3 == h.vertexNormalsLength ? (Da.copy(nb),
            Aa.copy(nb),
            Ia.copy(nb),
            n(h.v1.positionWorld, h.vertexNormalsModel[0], Da),
            n(h.v2.positionWorld, h.vertexNormalsModel[1], Aa),
            n(h.v3.positionWorld, h.vertexNormalsModel[2], Ia),
            Da.multiply(ma).add(wa),
            Aa.multiply(ma).add(wa),
            Ia.multiply(ma).add(wa),
            Ja.addColors(Aa, Ia).multiplyScalar(0.5),
            Z = jb(Da, Aa, Ia, Ja),
            I(B, K, L, U, aa, ba, 0, 0, 1, 0, 0, 1, Z)) : (fa.copy(nb),
            n(h.centroidModel, h.normalModel, fa),
            fa.multiply(ma).add(wa),
            !0 === Y.wireframe ? v(fa, Y.wireframeLinewidth, Y.wireframeLinecap, Y.wireframeLinejoin) : x(fa)) : !0 === Y.wireframe ? v(Y.color, Y.wireframeLinewidth, Y.wireframeLinecap, Y.wireframeLinejoin) : x(Y.color)) : Y instanceof THREE.MeshBasicMaterial || Y instanceof THREE.MeshLambertMaterial || Y instanceof THREE.MeshPhongMaterial ? null !== Y.map ? Y.map.mapping instanceof THREE.UVMapping && (pa = h.uvs[0],
            z(B, K, L, U, aa, ba, pa[g].x, pa[g].y, pa[j].x, pa[j].y, pa[i].x, pa[i].y, Y.map)) : null !== Y.envMap ? Y.envMap.mapping instanceof THREE.SphericalReflectionMapping && (ib.copy(h.vertexNormalsModelView[g]),
            gb = 0.5 * ib.x + 0.5,
            hb = 0.5 * ib.y + 0.5,
            ib.copy(h.vertexNormalsModelView[j]),
            Ea = 0.5 * ib.x + 0.5,
            yb = 0.5 * ib.y + 0.5,
            ib.copy(h.vertexNormalsModelView[i]),
            Cb = 0.5 * ib.x + 0.5,
            Lb = 0.5 * ib.y + 0.5,
            z(B, K, L, U, aa, ba, gb, hb, Ea, yb, Cb, Lb, Y.envMap)) : (fa.copy(Y.color),
            Y.vertexColors === THREE.FaceColors && fa.multiply(h.color),
            !0 === Y.wireframe ? v(fa, Y.wireframeLinewidth, Y.wireframeLinecap, Y.wireframeLinejoin) : x(fa)) : Y instanceof THREE.MeshDepthMaterial ? (ra = l.near,
            ga = l.far,
            j = 1 - cb(a.positionScreen.z * a.positionScreen.w, ra, ga),
            Da.setRGB(j, j, j),
            j = 1 - cb(d.positionScreen.z * d.positionScreen.w, ra, ga),
            Aa.setRGB(j, j, j),
            j = 1 - cb(e.positionScreen.z * e.positionScreen.w, ra, ga),
            Ia.setRGB(j, j, j),
            Ja.addColors(Aa, Ia).multiplyScalar(0.5),
            Z = jb(Da, Aa, Ia, Ja),
            I(B, K, L, U, aa, ba, 0, 0, 1, 0, 0, 1, Z)) : Y instanceof THREE.MeshNormalMaterial && (Y.shading == THREE.FlatShading ? (d = h.normalModelView,
            fa.setRGB(d.x, d.y, d.z).multiplyScalar(0.5).addScalar(0.5),
            !0 === Y.wireframe ? v(fa, Y.wireframeLinewidth, Y.wireframeLinecap, Y.wireframeLinejoin) : x(fa)) : Y.shading == THREE.SmoothShading && (d = h.vertexNormalsModelView[g],
            Da.setRGB(d.x, d.y, d.z).multiplyScalar(0.5).addScalar(0.5),
            d = h.vertexNormalsModelView[j],
            Aa.setRGB(d.x, d.y, d.z).multiplyScalar(0.5).addScalar(0.5),
            d = h.vertexNormalsModelView[i],
            Ia.setRGB(d.x, d.y, d.z).multiplyScalar(0.5).addScalar(0.5),
            Ja.addColors(Aa, Ia).multiplyScalar(0.5),
            Z = jb(Da, Aa, Ia, Ja),
            I(B, K, L, U, aa, ba, 0, 0, 1, 0, 0, 1, Z)))
        }
        ...
        function z(a, b, c, d, f, g, j, i, h, Y, k, l, n) {
            if (!(n instanceof THREE.DataTexture || void 0 === n.image || 0 == n.image.width)) {
                ...
                b = ia[n.id],
                j = 4 * (Math.floor(j) + Math.floor(i) * n.image.width),
                fa.setRGB(b[j] / 255, b[j + 1] / 255, b[j + 2] / 255),
                x(fa)) : (m = 1 / m,
                n = (l * c - Y * f) * m,
                Y = (l * d - Y * g) * m,
                c = (h * f - k * c) * m,
                ...
                if (!(void 0 === S || !1 === S.visible)) {
                    ...
                    if (ja instanceof THREE.RenderableParticle) {
                        ...
                        var Va = void 0
                          ...
                          , Y = ja = void 0
                          , dd = void 0;
                        S instanceof THREE.ParticleBasicMaterial ? null === S.map ? (Wa = Za.object.scale.x,
                        Pa = Za.object.scale.y,
                        Wa *= Za.scale.x * r,
                        Pa *= Za.scale.y * p,
                        Ya.min.set(T.x - Wa, T.y - Pa),
                        Ya.max.set(T.x + Wa, T.y + Pa),
                        !1 !== Ua.isIntersectionBox(Ya) && (e(S.color.getStyle()),
                        q.save(),
                        q.translate(T.x, T.y),
                        q.rotate(-Za.rotation),
                        q.scale(Wa, Pa),
                        q.fillRect(-1, -1, 2, 2),
                        q.restore())) : (ja = S.map.image,
                        Y = ja.width >> 1,
                        dd = ja.height >> 1,
                        Wa = Za.scale.x * r,
                        Pa = Za.scale.y * p,
                        Va = Wa * Y,
                        $a = Pa * dd,
                        Ya.min.set(T.x - Va, T.y - $a),
                        Ya.max.set(T.x + Va, T.y + $a),
                        !1 !== Ua.isIntersectionBox(Ya) && (q.save(),
                        q.translate(T.x, T.y),
                        q.rotate(-Za.rotation),
                        q.scale(Wa, -Pa),
                        q.translate(-Y, -dd),
                        q.drawImage(ja, 0, 0),
                        q.restore())) : S instanceof THREE.ParticleCanvasMaterial && (Va = Za.scale.x * r,
                        $a = Za.scale.y * p,
                        Ya.min.set(T.x - Va, T.y - $a),
                        Ya.max.set(T.x + Va, T.y + $a),
                        !1 !== Ua.isIntersectionBox(Ya) && (d(S.color.getStyle()),
                        e(S.color.getStyle()),
                        q.save(),
                        q.translate(T.x, T.y),
                        q.rotate(-Za.rotation),
                        ...
                        !0 === Ua.isIntersectionBox(Ya) && (T = F,
                        Za = E,
                        b(S.opacity),
                        c(S.blending),
                        q.beginPath(),
                        q.moveTo(T.positionScreen.x, T.positionScreen.y),
                        q.lineTo(Za.positionScreen.x, Za.positionScreen.y),
                        ...
                        d(S.color.getStyle()),
                        q.stroke(),
                        Ya.expandByScalar(2 * S.linewidth)));
                    else if (ja instanceof THREE.RenderableFace3) {
                        F = ja.v1;
                        E = ja.v2;
                        G = ja.v3;
                        if (-1 > F.positionScreen.z || 1 < F.positionScreen.z)
                            continue;
                        if (-1 > E.positionScreen.z || 1 < E.positionScreen.z)
                            continue;
                        if (-1 > G.positionScreen.z || 1 < G.positionScreen.z)
                            continue;
                        F.positionScreen.x *= r;
                        F.positionScreen.y *= p;
                        E.positionScreen.x *= r;
                        ...
                        !0 === S.overdraw && (kb(F.positionScreen, E.positionScreen),
                        kb(E.positionScreen, G.positionScreen),
                        kb(G.positionScreen, F.positionScreen));
                        Ya.setFromPoints([F.positionScreen, E.positionScreen, G.positionScreen]);
                        ...
                        W.positionScreen.y *= p;
                        A.positionScreen.copy(E.positionScreen);
                        X.positionScreen.copy(W.positionScreen);
                        !0 === S.overdraw && (kb(F.positionScreen, E.positionScreen),
                        kb(E.positionScreen, W.positionScreen),
                        kb(W.positionScreen, F.positionScreen),
                        kb(G.positionScreen, A.positionScreen),
                        kb(G.positionScreen, X.positionScreen));
                        ...
                        b(S.opacity);
                        c(S.blending);
                        void 0 !== S.map && null !== S.map || void 0 !== S.envMap && null !== S.envMap ? (m(T, Za, $a, 0, 1, 3, ja, S, Y),
                        m(Wa, Va, Pa, 1, 2, 3, ja, S, Y)) : (B = T.positionScreen.x,
                        K = T.positionScreen.y,
                        L = Za.positionScreen.x,
                        U = Za.positionScreen.y,
                        aa = Va.positionScreen.x,
                        ba = Va.positionScreen.y,
                        xa = $a.positionScreen.x,
                        J = $a.positionScreen.y,
                        ha = Wa.positionScreen.x,
                        ua = Wa.positionScreen.y,
                        Oa = Pa.positionScreen.x,
                        M = Pa.positionScreen.y,
                        S instanceof THREE.MeshLambertMaterial || S instanceof THREE.MeshPhongMaterial ? (ma.copy(S.color),
                        wa.copy(S.emissive),
                        S.vertexColors === THREE.FaceColors && ma.multiply(ja.color),
                        !0 === Db ? !1 === S.wireframe && S.shading == THREE.SmoothShading && 4 == ja.vertexNormalsLength ? (Da.copy(nb),
                        Aa.copy(nb),
                        Ia.copy(nb),
                        Ja.copy(nb),
                        n(ja.v1.positionWorld, ja.vertexNormalsModel[0], Da),
                        n(ja.v2.positionWorld, ja.vertexNormalsModel[1], Aa),
                        n(ja.v4.positionWorld, ja.vertexNormalsModel[3], Ia),
                        n(ja.v3.positionWorld, ja.vertexNormalsModel[2], Ja),
                        Da.multiply(ma).add(wa),
                        Aa.multiply(ma).add(wa),
                        Ia.multiply(ma).add(wa),
                        Ja.multiply(ma).add(wa),
                        Z = jb(Da, Aa, Ia, Ja),
                        s(B, K, L, U, xa, J),
                        I(B, K, L, U, xa, J, 0, 0, 1, 0, 0, 1, Z),
                        s(ha, ua, aa, ba, Oa, M),
                        I(ha, ua, aa, ba, Oa, M, 1, 0, 1, 1, 0, 1, Z)) : (fa.copy(nb),
                        n(ja.centroidModel, ja.normalModel, fa),
                        fa.multiply(ma).add(wa),
                        t(B, K, L, U, aa, ba, xa, J),
                        !0 === S.wireframe ? v(fa, S.wireframeLinewidth, S.wireframeLinecap, S.wireframeLinejoin) : x(fa)) : (fa.addColors(ma, wa),
                        t(B, K, L, U, aa, ba, xa, J),
                        !0 === S.wireframe ? v(fa, S.wireframeLinewidth, S.wireframeLinecap, S.wireframeLinejoin) : x(fa))) : S instanceof THREE.MeshBasicMaterial ? (fa.copy(S.color),
                        S.vertexColors === THREE.FaceColors && fa.multiply(ja.color),
                        t(B, K, L, U, aa, ba, xa, J),
                        !0 === S.wireframe ? v(fa, S.wireframeLinewidth, S.wireframeLinecap, S.wireframeLinejoin) : x(fa)) : S instanceof THREE.MeshNormalMaterial ? (T = void 0,
                        S.shading == THREE.FlatShading ? (T = ja.normalModelView,
                        fa.setRGB(T.x, T.y, T.z).multiplyScalar(0.5).addScalar(0.5),
                        t(B, K, L, U, aa, ba, xa, J),
                        !0 === S.wireframe ? v(fa, S.wireframeLinewidth, S.wireframeLinecap, S.wireframeLinejoin) : x(fa)) : S.shading == THREE.SmoothShading && (T = ja.vertexNormalsModelView[0],
                        Da.setRGB(T.x, T.y, T.z).multiplyScalar(0.5).addScalar(0.5),
                        T = ja.vertexNormalsModelView[1],
                        Aa.setRGB(T.x, T.y, T.z).multiplyScalar(0.5).addScalar(0.5),
                        T = ja.vertexNormalsModelView[3],
                        Ia.setRGB(T.x, T.y, T.z).multiplyScalar(0.5).addScalar(0.5),
                        T = ja.vertexNormalsModelView[2],
                        Ja.setRGB(T.x, T.y, T.z).multiplyScalar(0.5).addScalar(0.5),
                        Z = jb(Da, Aa, Ia, Ja),
                        s(B, K, L, U, xa, J),
                        I(B, K, L, U, xa, J, 0, 0, 1, 0, 0, 1, Z),
                        s(ha, ua, aa, ba, Oa, M),
                        I(ha, ua, aa, ba, Oa, M, 1, 0, 1, 1, 0, 1, Z))) : S instanceof THREE.MeshDepthMaterial && (ra = l.near,
                        ga = l.far,
                        Da.r = Da.g = Da.b = 1 - cb(T.positionScreen.z * T.positionScreen.w, ra, ga),
                        Aa.r = Aa.g = Aa.b = 1 - cb(Za.positionScreen.z * Za.positionScreen.w, ra, ga),
                        Ia.r = Ia.g = Ia.b = 1 - cb($a.positionScreen.z * $a.positionScreen.w, ra, ga),
                        Ja.r = Ja.g = Ja.b = 1 - cb(Va.positionScreen.z * Va.positionScreen.w, ra, ga),
                        Z = jb(Da, Aa, Ia, Ja),
                        s(B, K, L, U, xa, J),
                        I(B, K, L, U, xa, J, 0, 0, 1, 0, 0, 1, Z),
                        s(ha, ua, aa, ba, Oa, M),
                        I(ha, ua, aa, ba, Oa, M, 1, 0, 1, 1, 0, 1, Z)))
                    }
                    na.union(Ya)
                }
            }
...
THREE.WebGLRenderer = function(a) {
    ...
    function d(a, b) {
        ...
        m && (a.__colorArray = new Float32Array(3 * h));
        if (n) {
            ...
            if (1 < c.faceUvs.length || 1 < c.faceVertexUvs.length)
                a.__uv2Array = new Float32Array(2 * h)
        }
        ...
        if (d.attributes) {
            ...
            for (var q in d.attributes) {
                ...
                if (!c.__webglInitialized || c.createUniqueBuffers)
                    ...
                    i = 1,
                    "v2" === c.type ? i = 2 : "v3" === c.type ? i = 3 : "v4" === c.type ? i = 4 : "c" === c.type && (i = 3),
                    c.size = i,
                    c.array = new Float32Array(h * i),
                    c.buffer = j.createBuffer(),
                    c.buffer.belongsToAttribute = q,
                    k.needsUpdate = !0,
                    c.__original = k;
    ...
    function h(a, b, c) {
        ...
        a.uvsNeedUpdate && void 0 !== i && (j.bindBuffer(j.ARRAY_BUFFER, i.buffer),
        j.bufferData(j.ARRAY_BUFFER, i.array, b));
        a.colorsNeedUpdate && void 0 !== h && (j.bindBuffer(j.ARRAY_BUFFER, h.buffer),
    ...
    function k(a) {
        ib[a] || (j.enableVertexAttribArray(a),
        ib[a] = !0)
    }
    function l() {
        for (var a in ib)
            ib[a] && (j.disableVertexAttribArray(a),
            ib[a] = !1)
    }
    function m(a, b) {
    ...
    function r(a, b, c) {
        if (a.length)
            for (var d = 0, e = a.length; d < e; d++)
                wa = Aa = null,
                Ja = ma = ra = ia = Ea = hb = ga = -1,
                sb = !0,
                a[d].render(b, c, kc, Mb),
                wa = Aa = null,
                Ja = ma = ra = ia = Ea = hb = ga = -1,
                sb = !0
    }
    function p(a, b, c, d, e, f, g, j) {
        ...
        for (var l = h; l !== b; l += n)
            ...
            i.render) {
                ...
                k instanceof THREE.BufferGeometry ? M.renderBufferDirect(d, e, f, i, k, h) : M.renderBuffer(d, e, f, i, k, h)
            }
    }
    ...
    function I(a, b, c, d, e) {
        ...
        f = !0);
        if (f || a !== wa)
            j.uniformMatrix4fv(i.projectionMatrix, !1, a.projectionMatrix.elements),
            a !== wa && (wa = a);
        if (d.skinning)
            if (cb && e.useVertexTexture) {
                ...
                null !== i.boneGlobalMatrices && j.uniformMatrix4fv(i.boneGlobalMatrices, !1, e.boneMatrices);
        if (f) {
            ...
            if (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d.lights) {
                if (sb) {
                    for (var n, l = k = 0, m = 0, q, p, s, r = pb, t = r.directional.colors, v = r.directional.positions, x = r.point.colors, z = r.point.positions, D = r.point.distances, B = r.spot.colors, E = r.spot.positions, G = r.spot.distances, I = r.spot.directions, J = r.spot.anglesCos, fa = r.spot.exponents, S = r.hemi.skyColors, U = r.hemi.groundColors, W = r.hemi.positions, X = 0, T = 0, aa = 0, ia = 0, Da = 0, ja = 0, ma = 0, ba = 0, N = n = 0, c = s = N = 0, f = b.length; c < f; c++)
                        n = b[c],
                        n.onlyShadow || (q = n.color,
                        p = n.intensity,
                        s = n.distance,
                        n instanceof THREE.AmbientLight ? n.visible && (M.gammaInput ? (k += q.r * q.r,
                        l += q.g * q.g,
                        m += q.b * q.b) : (k += q.r,
                        l += q.g,
                        m += q.b)) : n instanceof THREE.DirectionalLight ? (Da += 1,
                        n.visible && (Fa.copy(n.matrixWorld.getPosition()),
                        Fa.sub(n.target.matrixWorld.getPosition()),
                        Fa.normalize(),
                        0 === Fa.x && 0 === Fa.y && 0 === Fa.z || (n = 3 * X,
                        v[n] = Fa.x,
                        v[n + 1] = Fa.y,
                        v[n + 2] = Fa.z,
                        M.gammaInput ? y(t, n, q, p * p) : F(t, n, q, p),
                        X += 1))) : n instanceof THREE.PointLight ? (ja += 1,
                        n.visible && (N = 3 * T,
                        M.gammaInput ? y(x, N, q, p * p) : F(x, N, q, p),
                        p = n.matrixWorld.getPosition(),
                        z[N] = p.x,
                        z[N + 1] = p.y,
                        z[N + 2] = p.z,
                        D[T] = s,
                        T += 1)) : n instanceof THREE.SpotLight ? (ma += 1,
                        n.visible && (N = 3 * aa,
                        M.gammaInput ? y(B, N, q, p * p) : F(B, N, q, p),
                        p = n.matrixWorld.getPosition(),
                        E[N] = p.x,
                        E[N + 1] = p.y,
                        E[N + 2] = p.z,
                        ...
                        I[N + 1] = Fa.y,
                        I[N + 2] = Fa.z,
                        J[aa] = Math.cos(n.angle),
                        fa[aa] = n.exponent,
                        aa += 1)) : n instanceof THREE.HemisphereLight && (ba += 1,
                        n.visible && (Fa.copy(n.matrixWorld.getPosition()),
                        Fa.normalize(),
                        0 === Fa.x && 0 === Fa.y && 0 === Fa.z || (s = 3 * ia,
                        W[s] = Fa.x,
                        W[s + 1] = Fa.y,
                        W[s + 2] = Fa.z,
                        q = n.color,
                        ...
                        ia += 1))));
                    c = 3 * X;
                    for (f = Math.max(t.length, 3 * Da); c < f; c++)
                        t[c] = 0;
                    c = 3 * T;
                    for (f = Math.max(x.length, 3 * ja); c < f; c++)
                        x[c] = 0;
                    c = 3 * aa;
                    for (f = Math.max(B.length, 3 * ma); c < f; c++)
                        B[c] = 0;
                    c = 3 * ia;
                    for (f = Math.max(S.length, 3 * ba); c < f; c++)
                        S[c] = 0;
                    c = 3 * ia;
                    for (f = Math.max(U.length, 3 * ba); c < f; c++)
                        U[c] = 0;
            ...
            if (d instanceof THREE.MeshBasicMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.MeshPhongMaterial) {
                ...
                M.gammaInput ? h.diffuse.value.copyGammaToLinear(d.color) : h.diffuse.value = d.color;
                h.map.value = d.map;
                ...
                void 0 !== Z && (c = Z.offset,
                Z = Z.repeat,
                h.offsetRepeat.value.set(c.x, c.y, Z.x, Z.y));
                h.envMap.value = d.envMap;
                h.flipEnvMap.value = d.envMap instanceof THREE.WebGLRenderTargetCube ? 1 : -1;
            ...
            h.scale.value = d.scale) : d instanceof THREE.ParticleBasicMaterial ? (h.psColor.value = d.color,
            h.opacity.value = d.opacity,
            h.size.value = d.size,
            h.scale.value = L.height / 2,
            h.map.value = d.map) : d instanceof THREE.MeshPhongMaterial ? (h.shininess.value = d.shininess,
            M.gammaInput ? (h.ambient.value.copyGammaToLinear(d.ambient),
            h.emissive.value.copyGammaToLinear(d.emissive),
            h.specular.value.copyGammaToLinear(d.specular)) : (h.ambient.value = d.ambient,
            h.emissive.value = d.emissive,
            h.specular.value = d.specular),
            d.wrapAround && h.wrapRGB.value.copy(d.wrapRGB)) : d instanceof THREE.MeshLambertMaterial ? (M.gammaInput ? (h.ambient.value.copyGammaToLinear(d.ambient),
            h.emissive.value.copyGammaToLinear(d.emissive)) : (h.ambient.value = d.ambient,
            h.emissive.value = d.emissive),
            ...
            if (e.receiveShadow && !d._shadowPass && h.shadowMatrix) {
                ...
                for (f = b.length; c < f; c++)
                    ...
                    k.castShadow && (k instanceof THREE.SpotLight || k instanceof THREE.DirectionalLight && !k.shadowCascade))
                        h.shadowMap.value[Z] = k.shadowMap,
                        h.shadowMapSize.value[Z] = k.shadowMapSize,
                        h.shadowMatrix.value[Z] = k.shadowMatrix,
                        h.shadowDarkness.value[Z] = k.shadowDarkness,
                        h.shadowBias.value[Z] = k.shadowBias,
                        Z++
            }
            b = d.uniformsList;
            h = 0;
                            ...
                            if (r.image instanceof Array && 6 === r.image.length) {
                                ...
                                6 === c.image.length)
                                    if (c.needsUpdate) {
                                        ...
                                        k = [];
                                        for (l = 0; 6 > l; l++)
                                            M.autoScaleCubemaps && !f ? (m = k,
                                            r = l,
                                            t = c.image[l],
                                            x = ad,
                                            t.width <= x && t.height <= x || (z = Math.max(t.width, t.height),
                                            v = Math.floor(t.width * x / z),
                                            x = Math.floor(t.height * x / z),
                                            z = document.createElement("canvas"),
                                            z.width = v,
                                            z.height = x,
                                            z.getContext("2d").drawImage(t, 0, 0, t.width, t.height, 0, 0, v, x),
                                            t = z),
                                            m[r] = t) : k[l] = c.image[l];
                                        l = k[0];
                                ...
                                j.bindTexture(j.TEXTURE_CUBE_MAP, c.__webglTexture)) : M.setTexture(r, k)
                    } else if ("tv" === l) {
            ...
            if ((d instanceof THREE.ShaderMaterial || d instanceof THREE.MeshPhongMaterial || d.envMap) && null !== i.cameraPosition)
                b = a.matrixWorld.getPosition(),
                j.uniform3f(i.cameraPosition, b.x, b.y, b.z);
            (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.ShaderMaterial || d.skinning) && null !== i.viewMatrix && j.uniformMatrix4fv(i.viewMatrix, !1, a.matrixWorldInverse.elements)
        }
    ...
    function E(a, b, c) {
        yb !== a && (a ? j.enable(j.POLYGON_OFFSET_FILL) : j.disable(j.POLYGON_OFFSET_FILL),
        yb = a);
        if (a && (Cb !== b || Lb !== c))
            j.polygonOffset(b, c),
            Cb = b,
    ...
    function A(a, b, c) {
        c ? (j.texParameteri(a, j.TEXTURE_WRAP_S, K(b.wrapS)),
        j.texParameteri(a, j.TEXTURE_WRAP_T, K(b.wrapT)),
        j.texParameteri(a, j.TEXTURE_MAG_FILTER, K(b.magFilter)),
        j.texParameteri(a, j.TEXTURE_MIN_FILTER, K(b.minFilter))) : (j.texParameteri(a, j.TEXTURE_WRAP_S, j.CLAMP_TO_EDGE),
        j.texParameteri(a, j.TEXTURE_WRAP_T, j.CLAMP_TO_EDGE),
        j.texParameteri(a, j.TEXTURE_MAG_FILTER, B(b.magFilter)),
        j.texParameteri(a, j.TEXTURE_MIN_FILTER, B(b.minFilter)));
        if (Eb && b.type !== THREE.FloatType && (1 < b.anisotropy || b.__oldAnisotropy))
            j.texParameterf(a, Eb.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(b.anisotropy, Jc)),
    ...
    function K(a) {
        ...
        if (void 0 !== Ab) {
            if (a === THREE.RGB_S3TC_DXT1_Format)
                return Ab.COMPRESSED_RGB_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT1_Format)
                return Ab.COMPRESSED_RGBA_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT3_Format)
                return Ab.COMPRESSED_RGBA_S3TC_DXT3_EXT;
            if (a === THREE.RGBA_S3TC_DXT5_Format)
                return Ab.COMPRESSED_RGBA_S3TC_DXT5_EXT
        }
        return 0
    }
    ...
    var M = this, fa = [], Da = 0, Aa = null, Ia = null, Ja = -1, ma = null, wa = null, Ta = 0, Ra = 0, ia = -1, ra = -1, ga = -1, Z = -1, pa = -1, gb = -1, hb = -1, Ea = -1, yb = null, Cb = null, Lb = null, Ua = null, na = 0, Ya = 0, Db = 0, nb = 0, kc = 0, Mb = 0, ib = {}, zb = new THREE.Frustum, Ob = new THREE.Matrix4, rc = new THREE.Matrix4, ob = new THREE.Vector3, Fa = new THREE.Vector3, sb = !0, pb = {
        ambient: [0, 0, 0],
        directional: {
            length: 0,
            colors: [],
    ...
    Eb = j.getExtension("EXT_texture_filter_anisotropic") || j.getExtension("MOZ_EXT_texture_filter_anisotropic") || j.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
    ...
    var ad = j.getParameter(j.MAX_CUBE_MAP_TEXTURE_SIZE)
      , Jc = Eb ? j.getParameter(Eb.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 0
      , jb = 0 < $c
      , cb = jb && lc;
    ...
    "highp" === U && !T && (ja ? (U = "mediump",
    console.warn("WebGLRenderer: highp not supported, using mediump")) : (U = "lowp",
        ...
        if (!1 !== d.visible)
            ...
            f instanceof THREE.Mesh)
                if (f = e.attributes.index) {
                    ...
                    for (var c = 0, g = d.length; c < g; c++) {
                        ...
                        if (b) {
                            ...
                            if (0 <= a.normal && n) {
                                ...
                                k(a.normal);
                                j.vertexAttribPointer(a.normal, m, j.FLOAT, !1, 0, 4 * h * m)
                            }
                            n = e.attributes.uv;
                            0 <= a.uv && n && (m = n.itemSize,
                            j.bindBuffer(j.ARRAY_BUFFER, n.buffer),
                            k(a.uv),
                            j.vertexAttribPointer(a.uv, m, j.FLOAT, !1, 0, 4 * h * m));
                            n = e.attributes.color;
                            0 <= a.color && n && (m = n.itemSize,
                            j.bindBuffer(j.ARRAY_BUFFER, n.buffer),
                            k(a.color),
                            j.vertexAttribPointer(a.color, m, j.FLOAT, !1, 0, 4 * h * m));
                            n = e.attributes.tangent;
                            0 <= a.tangent && n && (m = n.itemSize,
                            j.bindBuffer(j.ARRAY_BUFFER, n.buffer),
                            k(a.tangent),
                            j.vertexAttribPointer(a.tangent, m, j.FLOAT, !1, 0, 4 * h * m));
                    ...
                    M.info.render.calls++,
                    M.info.render.vertices += i.numItems / 3,
                    M.info.render.faces += i.numItems / 3 / 3;
            else
                f instanceof THREE.ParticleSystem ? b && (i = e.attributes.position,
                n = i.itemSize,
                j.bindBuffer(j.ARRAY_BUFFER, i.buffer),
                k(a.position),
                j.vertexAttribPointer(a.position, n, j.FLOAT, !1, 0, 0),
                ...
                M.info.render.calls++,
                M.info.render.points += i.numItems / 3) : f instanceof THREE.Line && b && (i = e.attributes.position,
                n = i.itemSize,
                j.bindBuffer(j.ARRAY_BUFFER, i.buffer),
                k(a.position),
                j.vertexAttribPointer(a.position, n, j.FLOAT, !1, 0, 0),
                ...
                k(a.color),
                j.vertexAttribPointer(a.color, m, j.FLOAT, !1, 0, 0)),
                j.drawArrays(j.LINE_STRIP, 0, i.numItems / 3),
                M.info.render.calls++,
                M.info.render.points += i.numItems)
    }
    ;
    this.renderBuffer = function(a, b, c, d, e, f) {
        if (!1 !== d.visible) {
            ...
            if (!d.morphTargets && 0 <= b.position)
                a && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglVertexBuffer),
                k(b.position),
                ...
                if (f.morphTargetForcedOrder.length) {
                    ...
                    for (g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length; )
                        0 <= c["morphTarget" + i] && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[h[i]]),
                        k(c["morphTarget" + i]),
                        j.vertexAttribPointer(c["morphTarget" + i], 3, j.FLOAT, !1, 0, 0)),
                        0 <= c["morphNormal" + i] && d.morphNormals && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[h[i]]),
                        k(c["morphNormal" + i]),
                        j.vertexAttribPointer(c["morphNormal" + i], 3, j.FLOAT, !1, 0, 0)),
                    ...
                    for (m = 0; m < p; m++)
                        i = g[m],
                        0 < i && h.push([i, m]);
                    h.length > d.numSupportedMorphTargets ? (h.sort(n),
                    h.length = d.numSupportedMorphTargets) : h.length > d.numSupportedMorphNormals ? h.sort(n) : 0 === h.length && h.push([0, 0]);
                    for (i = 0; i < d.numSupportedMorphTargets; )
                        h[i] ? (m = h[i][1],
                        0 <= c["morphTarget" + i] && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[m]),
                        k(c["morphTarget" + i]),
                        j.vertexAttribPointer(c["morphTarget" + i], 3, j.FLOAT, !1, 0, 0)),
                        0 <= c["morphNormal" + i] && d.morphNormals && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[m]),
                        k(c["morphNormal" + i]),
                        j.vertexAttribPointer(c["morphNormal" + i], 3, j.FLOAT, !1, 0, 0)),
                        f.__webglMorphTargetInfluences[i] = g[m]) : f.__webglMorphTargetInfluences[i] = 0,
                        i++
                }
            ...
            if (a) {
                if (e.__webglCustomAttributesList) {
                    ...
                    for (h = e.__webglCustomAttributesList.length; g < h; g++)
                        ...
                        0 <= b[c.buffer.belongsToAttribute] && (j.bindBuffer(j.ARRAY_BUFFER, c.buffer),
                        k(b[c.buffer.belongsToAttribute]),
                        j.vertexAttribPointer(b[c.buffer.belongsToAttribute], c.size, j.FLOAT, !1, 0, 0))
                }
                0 <= b.color && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglColorBuffer),
                k(b.color),
                j.vertexAttribPointer(b.color, 3, j.FLOAT, !1, 0, 0));
                0 <= b.normal && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglNormalBuffer),
                k(b.normal),
                j.vertexAttribPointer(b.normal, 3, j.FLOAT, !1, 0, 0));
                0 <= b.tangent && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglTangentBuffer),
                k(b.tangent),
                ...
                0 <= b.uv2 && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglUV2Buffer),
                k(b.uv2),
                j.vertexAttribPointer(b.uv2, 2, j.FLOAT, !1, 0, 0));
                d.skinning && (0 <= b.skinIndex && 0 <= b.skinWeight) && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglSkinIndicesBuffer),
                k(b.skinIndex),
                ...
                0 <= b.lineDistance && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglLineDistanceBuffer),
                k(b.lineDistance),
            ...
            j.drawElements(j.LINES, e.__webglLineCount, j.UNSIGNED_SHORT, 0)) : (a && j.bindBuffer(j.ELEMENT_ARRAY_BUFFER, e.__webglFaceBuffer),
            j.drawElements(j.TRIANGLES, e.__webglFaceCount, j.UNSIGNED_SHORT, 0)),
            M.info.render.calls++,
            M.info.render.vertices += e.__webglFaceCount,
            M.info.render.faces += e.__webglFaceCount / 3) : f instanceof THREE.Line ? (f = f.type === THREE.LineStrip ? j.LINE_STRIP : j.LINES,
            d = d.linewidth,
            d !== Ua && (j.lineWidth(d),
            Ua = d),
            j.drawArrays(f, 0, e.__webglLineCount),
            M.info.render.calls++) : f instanceof THREE.ParticleSystem ? (j.drawArrays(j.POINTS, 0, e.__webglParticleCount),
            M.info.render.calls++,
            M.info.render.points += e.__webglParticleCount) : f instanceof THREE.Ribbon && (j.drawArrays(j.TRIANGLE_STRIP, 0, e.__webglVertexCount),
            M.info.render.calls++)
        }
    }
    ;
    this.render = function(a, b, c, d) {
        if (!1 === b instanceof THREE.Camera)
            ...
            for (e = h.length; d < e; d++)
                ...
                g = f.object,
                f.render = !1,
                g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || zb.intersectsObject(g))) {
                    D(g, b);
                    var n = f
                      , l = n.buffer
                      , s = void 0
                    ...
                    if (t instanceof THREE.MeshFaceMaterial)
                        s = l.materialIndex,
                        s = t.materials[s],
                        s.transparent ? (n.transparent = s,
                        n.opaque = null) : (n.opaque = s,
                        n.transparent = null);
                    else if (s = t)
                        s.transparent ? (n.transparent = s,
                        n.opaque = null) : (n.opaque = s,
                        n.transparent = null);
                    f.render = !0;
                    !0 === this.sortObjects && (null !== g.renderDepth ? f.z = g.renderDepth : (ob.copy(g.matrixWorld.getPosition()),
                    ob.applyProjection(Ob),
                    f.z = ob.z),
                    f.id = g.id)
                }
            ...
            p(a.__webglObjects, !1, "", b, i, k, !0, d),
            q(a.__webglObjectsImmediate, "", b, i, k, !1, d)) : (d = null,
            this.setBlending(THREE.NoBlending),
            p(a.__webglObjects, !0, "opaque", b, i, k, !1, d),
            q(a.__webglObjectsImmediate, "opaque", b, i, k, !1, d),
            p(a.__webglObjects, !1, "transparent", b, i, k, !0, d),
            q(a.__webglObjectsImmediate, "transparent", b, i, k, !0, d));
    ...
    this.initWebGLObjects = function(a) {
        ...
        for (; a.__objectsAdded.length; ) {
            ...
            if (!b.__webglInit)
                ...
                b.geometry.addEventListener("dispose", Za)),
                b instanceof THREE.Mesh)
                    ...
                    m instanceof THREE.Geometry) {
                        if (void 0 === m.geometryGroups) {
                            ...
                            r.geometryGroups = {};
                            y = 0;
                            for (A = r.faces.length; y < A; y++)
                                D = r.faces[y],
                                B = K ? D.materialIndex : 0,
                                void 0 === G[B] && (G[B] = {
                                    hash: B,
                                    counter: 0
                                }),
                                E = G[B].hash + "_" + G[B].counter,
                                void 0 === r.geometryGroups[E] && (r.geometryGroups[E] = {
                                    faces3: [],
                                    faces4: [],
                                    materialIndex: B,
                                    vertices: 0,
                                ...
                                F = D instanceof THREE.Face3 ? 3 : 4,
                                65535 < r.geometryGroups[E].vertices + F && (G[B].counter += 1,
                                E = G[B].hash + "_" + G[B].counter,
                                void 0 === r.geometryGroups[E] && (r.geometryGroups[E] = {
                                    faces3: [],
                                    faces4: [],
                                ...
                                D instanceof THREE.Face3 ? r.geometryGroups[E].faces3.push(y) : r.geometryGroups[E].faces4.push(y),
                                r.geometryGroups[E].vertices += F;
                            r.geometryGroupsList = [];
                            var L = void 0;
                            for (L in r.geometryGroups)
                                r.geometryGroups[L].id = Ta++,
                                r.geometryGroupsList.push(r.geometryGroups[L])
                        }
                        for (l in m.geometryGroups)
                            if (q = m.geometryGroups[l],
                            !q.__webglVertexBuffer) {
                                var J = q;
                        ...
                        m instanceof THREE.BufferGeometry && i(m);
            ...
            if (!b.__webglActive) {
                if (b instanceof THREE.Mesh)
                    ...
                    m instanceof THREE.BufferGeometry)
                        s(k.__webglObjects, m, b);
                    else {
                        if (m instanceof THREE.Geometry)
                            for (l in m.geometryGroups)
                                q = m.geometryGroups[l],
                                s(k.__webglObjects, q, b)
                    }
                else
                    b instanceof THREE.Ribbon || b instanceof THREE.Line || b instanceof THREE.ParticleSystem ? (m = b.geometry,
                    s(k.__webglObjects, m, b)) : b instanceof THREE.ImmediateRenderObject || b.immediateRenderCallback ? k.__webglObjectsImmediate.push({
                        object: b,
                        opaque: null,
                        transparent: null
        ...
        for (var Ja = 0, ra = a.__webglObjects.length; Ja < ra; Ja++) {
            ...
            if (ha instanceof THREE.Mesh)
                if (N instanceof THREE.BufferGeometry)
                    (N.verticesNeedUpdate || N.elementsNeedUpdate || N.uvsNeedUpdate || N.normalsNeedUpdate || N.colorsNeedUpdate || N.tangentsNeedUpdate) && h(N, j.DYNAMIC_DRAW, !N.dynamic),
                    ...
                    for (var ua = 0, Ea = N.geometryGroupsList.length; ua < Ea; ua++)
                        if (Ra = N.geometryGroupsList[ua],
                        ga = e(ha, Ra),
                        N.buffersNeedUpdate && d(Ra, ha),
                        pa = ga.attributes && t(ga),
                        N.verticesNeedUpdate || N.morphTargetsNeedUpdate || N.elementsNeedUpdate || N.uvsNeedUpdate || N.normalsNeedUpdate || N.colorsNeedUpdate || N.tangentsNeedUpdate || pa) {
                            var qa = Ra
                              , Fa = ha
                              , na = j.DYNAMIC_DRAW
                              , Oa = !N.dynamic
                            ...
                            if (qa.__inittedArrays) {
                                ...
                                if (cd) {
                                    ...
                                    for (kc = pc.length; db < kc; db++) {
                                        ...
                                        for (V = sa.length; C < V; C++)
                                            nc = sa[C],
                                            O = rb[nc],
                                            P = pc[db].vertices[O.a],
                                            Q = pc[db].vertices[O.b],
                                            R = pc[db].vertices[O.c],
                                            ab = lc[db],
                                            ab[ka] = P.x,
                                            ab[ka + 1] = P.y,
                                            ab[ka + 2] = P.z,
                                            ...
                                            ab[ka + 7] = R.y,
                                            ab[ka + 8] = R.z,
                                            xa.morphNormals && (ib ? (fc = Kc[db].vertexNormals[nc],
                                            Pb = fc.a,
                                            Qb = fc.b,
                                            Rb = fc.c) : Rb = Qb = Pb = Kc[db].faceNormals[nc],
                                            bb = sc[db],
                                            bb[ka] = Pb.x,
                                            bb[ka + 1] = Pb.y,
                                            bb[ka + 2] = Pb.z,
                                        ...
                                        for (V = ta.length; C < V; C++)
                                            ...
                                            Qb = fc.b,
                                            Rb = fc.c,
                                            zb = fc.d) : zb = Rb = Qb = Pb = Kc[db].faceNormals[nc],
                                            bb = sc[db],
                                            bb[ka] = Pb.x,
                                            bb[ka + 1] = Pb.y,
                                            bb[ka + 2] = Pb.z,
                                        ...
                                        xa.morphNormals && (j.bindBuffer(j.ARRAY_BUFFER, qa.__webglMorphNormalsBuffers[db]),
                                        j.bufferData(j.ARRAY_BUFFER, sc[db], na))
                                    }
                                }
                                if (oc.length) {
                                    C = 0;
                                    ...
                                    j.bufferData(j.ARRAY_BUFFER, La, na),
                                    j.bindBuffer(j.ARRAY_BUFFER, qa.__webglSkinWeightsBuffer),
                                    j.bufferData(j.ARRAY_BUFFER, Ma, na))
                                }
                                if (bd && gb) {
                                    C = 0;
                                    for (V = sa.length; C < V; C++)
                                        ...
                                        Pa = O.vertexColors,
                                        nb = O.color,
                                        3 === Pa.length && gb === THREE.VertexColors ? (Sb = Pa[0],
                                        Tb = Pa[1],
                                        Ub = Pa[2]) : Ub = Tb = Sb = nb,
                                        fb[Sa] = Sb.r,
                                        fb[Sa + 1] = Sb.g,
                                    ...
                                    for (V = ta.length; C < V; C++)
                                        ...
                                        Pa = O.vertexColors,
                                        nb = O.color,
                                        4 === Pa.length && gb === THREE.VertexColors ? (Sb = Pa[0],
                                        Tb = Pa[1],
                                        Ub = Pa[2],
                                        Ab = Pa[3]) : Ab = Ub = Tb = Sb = nb,
                                        fb[Sa] = Sb.r,
                                        fb[Sa + 1] = Sb.g,
                                        fb[Sa + 2] = Sb.b,
                                        fb[Sa + 3] = Tb.r,
                                        ...
                                        fb[Sa + 11] = Ab.b,
                                        Sa += 12;
                                    0 < Sa && (j.bindBuffer(j.ARRAY_BUFFER, qa.__webglColorBuffer),
                                    j.bufferData(j.ARRAY_BUFFER, fb, na))
                                }
                                    ...
                                    for (V = ta.length; C < V; C++)
                                        ...
                                        void 0 !== hb)
                                            for (va = 0; 4 > va; va++)
                                                ...
                                                Mb[gc + 1] = Eb.y,
                                                gc += 2;
                                    0 < gc && (j.bindBuffer(j.ARRAY_BUFFER, qa.__webglUVBuffer),
                                    j.bufferData(j.ARRAY_BUFFER, Mb, na))
                                }
                                if (Bc && gd && pb) {
                                    C = 0;
                                    for (V = sa.length; C < V; C++)
                                    ...
                                    for (V = ta.length; C < V; C++)
                                        ...
                                        void 0 !== sb)
                                            for (va = 0; 4 > va; va++)
                                                ...
                                                Nb[hc + 1] = xc.y,
                                                hc += 2;
                                    0 < hc && (j.bindBuffer(j.ARRAY_BUFFER, qa.__webglUV2Buffer),
                                    j.bufferData(j.ARRAY_BUFFER, Nb, na))
                                }
                                if (Jc) {
                                    C = 0;
                                    for (V = sa.length; C < V; C++)
                                        ...
                                        u.__original.needsUpdate) {
                                            ...
                                            if (1 === u.size)
                                                if (void 0 === u.boundTo || "vertices" === u.boundTo) {
                                                    ...
                                                    for (V = sa.length; C < V; C++)
                                                        O = rb[sa[C]],
                                                        u.array[w] = u.value[O.a],
                                                        u.array[w + 1] = u.value[O.b],
                                                        u.array[w + 2] = u.value[O.c],
                                                        w += 3;
                                                    C = 0;
                                                    for (V = ta.length; C < V; C++)
                                                        O = rb[ta[C]],
                                ...
                                Oa && (delete qa.__inittedArrays,
                                delete qa.__colorArray,
                                delete qa.__normalArray,
                                delete qa.__tangentArray,
                                delete qa.__uvArray,
                                delete qa.__uv2Array,
                                delete qa.__faceArray,
                                delete qa.__vertexArray,
                                delete qa.__lineArray,
                                delete qa.__skinIndexArray,
                ...
                if (N.verticesNeedUpdate || N.colorsNeedUpdate || N.normalsNeedUpdate || pa) {
                    ...
                    if (hd) {
                        ...
                        for (md = hd.length; Pc < md; Pc++)
                            if (Ga = hd[Pc],
                            Ga.needsUpdate && (void 0 === Ga.boundTo || "vertices" === Ga.boundTo)) {
                                za = 0;
                                yc = Ga.value.length;
                                if (1 === Ga.size)
                                    for (lb = 0; lb < yc; lb++)
                                        Ga.array[lb] = Ga.value[lb];
                                else if (2 === Ga.size)
                                    for (lb = 0; lb < yc; lb++)
                                        vb = Ga.value[lb],
                                        Ga.array[za] = vb.x,
                ...
                if (N instanceof THREE.BufferGeometry)
                    (N.verticesNeedUpdate || N.colorsNeedUpdate) && h(N, j.DYNAMIC_DRAW, !N.dynamic),
                    N.verticesNeedUpdate = !1,
                    N.colorsNeedUpdate = !1;
                else {
                    ga = e(ha, N);
                    ...
                    if (N.verticesNeedUpdate || N.colorsNeedUpdate || N.lineDistancesNeedUpdate || pa) {
                        ...
                        if (Hd) {
                            ...
                            j.bufferData(j.ARRAY_BUFFER, td, Tc)
                        }
                        if (id) {
                            Yc = 0;
                            for (ud = id.length; Yc < ud; Yc++)
                                if (Ha = id[Yc],
                                Ha.needsUpdate && (void 0 === Ha.boundTo || "vertices" === Ha.boundTo)) {
                                    Na = 0;
                                    zc = Ha.value.length;
                                    if (1 === Ha.size)
                                        for (mb = 0; mb < zc; mb++)
                                            Ha.array[mb] = Ha.value[mb];
                                    else if (2 === Ha.size)
                                        for (mb = 0; mb < zc; mb++)
                                            wb = Ha.value[mb],
                                            Ha.array[Na] = wb.x,
                ...
                if (N instanceof THREE.BufferGeometry)
                    ...
                    if (N.verticesNeedUpdate || N.colorsNeedUpdate || ha.sortParticles || pa) {
                            ...
                            if (jc) {
                                ...
                                for (Ac = jc.length; Jb < Ac; Jb++)
                                    ...
                                    da.needsUpdate && (void 0 === da.boundTo || "vertices" === da.boundTo))
                                        if (Kb = da.value.length,
                                        ea = 0,
                                        1 === da.size)
                                            for (la = 0; la < Kb; la++)
                                                da.array[la] = da.value[la];
                                        else if (2 === da.size)
                                            for (la = 0; la < Kb; la++)
                                                Ca = da.value[la],
                                                da.array[ea] = Ca.x,
                        ...
                        if (wd || Ic.sortParticles)
                            j.bindBuffer(j.ARRAY_BUFFER, bc.__webglVertexBuffer),
                            j.bufferData(j.ARRAY_BUFFER, vc, jd);
                        if (xd || Ic.sortParticles)
                            j.bindBuffer(j.ARRAY_BUFFER, bc.__webglColorBuffer),
                            j.bufferData(j.ARRAY_BUFFER, wc, jd);
                        if (jc) {
                            Jb = 0;
                            for (Ac = jc.length; Jb < Ac; Jb++)
                                if (da = jc[Jb],
                                da.needsUpdate || Ic.sortParticles)
                                    j.bindBuffer(j.ARRAY_BUFFER, da.buffer),
                                    j.bufferData(j.ARRAY_BUFFER, da.array, jd)
                        }
                    }
                    N.verticesNeedUpdate = !1;
                    N.colorsNeedUpdate = !1;
    ...
    this.initMaterial = function(a, b, c, d) {
        ...
        for (f = b.length; e < f; e++)
            ...
            r instanceof THREE.PointLight && q++,
        ...
        for (s = b.length; p < s; p++)
            q = b[p],
            q.castShadow && (q instanceof THREE.SpotLight && r++,
            q instanceof THREE.DirectionalLight && !q.shadowCascade && r++);
        l = r;
        cb && d && d.useVertexTexture ? n = 1024 : (b = j.getParameter(j.MAX_VERTEX_UNIFORM_VECTORS),
        b = Math.floor((b - 20) / 4),
        ...
        a: {
            ...
            for (y = 0; y < c.maxMorphTargets; y++)
                t.push("morphTarget" + y);
            for (y = 0; y < c.maxMorphNormals; y++)
                t.push("morphNormal" + y);
            for (k in b)
                t.push(k);
            k = t;
            y = 0;
        ...
        if (a.morphTargets) {
            ...
            for (k = 0; k < this.maxMorphTargets; k++)
                x = b + k,
                0 <= y[x] && a.numSupportedMorphTargets++
        }
        if (a.morphNormals) {
            ...
            for (k = 0; k < this.maxMorphNormals; k++)
                x = b + k,
                0 <= y[x] && a.numSupportedMorphNormals++
        }
        a.uniformsList = [];
        for (i in a.uniforms)
    ...
    this.setMaterialFaces = function(a) {
        ...
        ia !== b && (b ? j.disable(j.CULL_FACE) : j.enable(j.CULL_FACE),
        ia = b);
        ra !== a && (a ? j.frontFace(j.CW) : j.frontFace(j.CCW),
        ra = a)
    }
    ;
    this.setDepthTest = function(a) {
        hb !== a && (a ? j.enable(j.DEPTH_TEST) : j.disable(j.DEPTH_TEST),
        hb = a)
    }
    ;
    ...
    this.setBlending = function(a, b, c, d) {
        a !== ga && (a === THREE.NoBlending ? j.disable(j.BLEND) : a === THREE.AdditiveBlending ? (j.enable(j.BLEND),
        j.blendEquation(j.FUNC_ADD),
    ...
    this.setRenderTarget = function(a) {
        ...
        d = na,
        e = Ya);
        b !== Ia && (j.bindFramebuffer(j.FRAMEBUFFER, b),
        j.viewport(d, e, c, a),
        Ia = b);
        kc = c;
        Mb = a
...
THREE.GeometryUtils = {
    merge: function(a, b) {
        ...
        for (n = k.length; m < n; m++) {
            ...
            r instanceof THREE.Face3 ? p = new THREE.Face3(r.a + e,r.b + e,r.c + e) : r instanceof THREE.Face4 && (p = new THREE.Face4(r.a + e,r.b + e,r.c + e,r.d + e));
            p.normal.copy(r.normal);
            d && p.normal.applyMatrix3(d).normalize();
            g = 0;
            for (i = s.length; g < i; g++)
                q = s[g].clone(),
                d && q.applyMatrix3(d).normalize(),
                p.vertexNormals.push(q);
            p.color.copy(r.color);
            g = 0;
            for (i = t.length; g < i; g++)
                q = t[g],
                p.vertexColors.push(q.clone());
    ...
    randomPointsInGeometry: function(a, b) {
        ...
        for (e = 0; e < i; e++)
            ...
            n = g[d.c],
            r = g[d.d],
            d._area1 = THREE.GeometryUtils.triangleArea(l, m, r),
            d._area2 = THREE.GeometryUtils.triangleArea(m, n, r),
            d._area = d._area1 + d._area2),
            h += d._area,
            k[e] = h;
        d = [];
        for (e = 0; e < b; e++)
            g = THREE.GeometryUtils.random() * h,
            g = c(g),
        ...
        for (c = a.faces.length; b < c; b++)
            ...
            d instanceof THREE.Face4) {
                ...
                for (e = a.faceVertexUvs.length; d < e; d++)
                    ...
                    k = m[2],
                    l = m[3],
                    m = [m[0].clone(), h.clone(), l.clone()],
                    h = [h.clone(), k.clone(), l.clone()],
                    i[d].push(m, h));
                d = 0;
                for (e = a.faceUvs.length; d < e; d++)
                    a.faceUvs[d].length && (h = a.faceUvs[d][b],
                    g[d].push(h, h))
            } else {
                f.push(d);
                d = 0;
...
THREE.ImageUtils = {
    ...
    parseDDS: function(a, b) {
        ...
        case g:
            ...
            break;
        default:
            return console.error("ImageUtils.parseDDS(): Unsupported FourCC code: ", String.fromCharCode(h & 255, h >> 8 & 255, h >> 16 & 255, h >> 24 & 255)),
            d
        }
        d.mipmapCount = 1;
        ...
        d.width = i[4];
        d.height = i[3];
        for (var i = i[1] + 4, f = d.width, g = d.height, h = d.isCubemap ? 6 : 1, k = 0; k < h; k++) {
    ...
    getNormalMap: function(a, b) {
        ...
        g.drawImage(a, 0, 0);
        for (var i = g.getImageData(0, 0, d, e).data, h = g.createImageData(d, e), k = h.data, l = 0; l < d; l++)
            for (var m = 0; m < e; m++) {
                var n = 0 > m - 1 ? 0 : m - 1
                  , r = m + 1 > e - 1 ? e - 1 : m + 1
                  , p = 0 > l - 1 ? 0 : l - 1
    ...
    generateDataTexture: function(a, b, c) {
        for (var d = a * b, e = new Uint8Array(3 * d), f = Math.floor(255 * c.r), g = Math.floor(255 * c.g), c = Math.floor(255 * c.b), i = 0; i < d; i++)
            e[3 * i] = f,
            e[3 * i + 1] = g,
            e[3 * i + 2] = c;
                ...
                for (a = 0; a < k; )
                    ...
                    case "b":
                        ...
                        g = f[f.length - 1]) {
                            ...
                            for (i = this.divisions; g <= i; g++)
                                x = g / i,
                                THREE.Shape.Utils.b3(x, m, r, q, h),
                                THREE.Shape.Utils.b3(x, n, p, s, l)
                        }
                    }
            }
            return {
...
THREE.CurvePath.prototype.getBoundingBox = function() {
    ...
    for (k = a.length; h < k; h++)
        i = a[h],
        i.x > b ? b = i.x : i.x < e && (e = i.x),
        i.y > c ? c = i.y : i.y < f && (f = i.y),
        m && (i.z > d ? d = i.z : i.z < g && (g = i.z)),
        l.add(i);
    a = {
        minX: e,
        minY: f,
...
THREE.CurvePath.prototype.getWrapPoints = function(a, b) {
    ...
    for (e = a.length; d < e; d++)
        ...
        i = f.y,
        h = g / c.maxX,
        h = b.getUtoTmapping(h, g),
        g = b.getPoint(h),
        i = b.getNormalVector(h).multiplyScalar(i),
        f.x = g.x + i.x,
        f.y = g.y + i.y;
    return a
}
...
THREE.Path.prototype.getPoints = function(a, b) {
    ...
    for (e = this.actions.length; d < e; d++)
        ...
        case THREE.PathActions.QUADRATIC_CURVE_TO:
            ...
            r = g.x,
            p = g.y) : (g = this.actions[d - 1].args,
            r = g[g.length - 2],
            p = g[g.length - 1]);
            for (f = 1; f <= a; f++)
                q = f / a,
                g = THREE.Shape.Utils.b2(q, r, m, i),
                q = THREE.Shape.Utils.b2(q, p, n, h),
        ...
        case THREE.PathActions.BEZIER_CURVE_TO:
            ...
            for (f = 1; f <= a; f++)
                q = f / a,
                g = THREE.Shape.Utils.b3(q, r, m, k, i),
                q = THREE.Shape.Utils.b3(q, p, n, l, h),
                c.push(new THREE.Vector2(g,q));
            break;
...
THREE.Shape.Utils = {
    ...
    triangulateShape: function(a, b) {
        ...
        for (g = d.length; f < g; f++)
            h = d[f].x + ":" + d[f].y,
            void 0 !== k[h] && console.log("Duplicate point", h),
            k[h] = f;
        f = 0;
                ...
                if (i.time <= l) {
                    if (k < l)
                        if (this.loop) {
                            ...
                            for (i = this.getNextKeyWith(c, m, 1); i.time < k; )
                                g = i,
                                i = this.getNextKeyWith(c, m, i.index + 1)
                        } else {
                            this.stop();
                            return
                        }
                ...
                if ("pos" === c)
                    ...
                    this.interpolationType === THREE.AnimationHandler.LINEAR)
                        ...
                        if (this.interpolationType === THREE.AnimationHandler.CATMULLROM || this.interpolationType === THREE.AnimationHandler.CATMULLROM_FORWARD)
                            ...
                            this.points[1] = e,
                            this.points[2] = f,
                            this.points[3] = this.getNextKeyWith("pos", m, i.index + 1).pos,
                            d = 0.33 * d + 0.33,
            ...
            for (var a = 0, k = this.hierarchy.length; a < k; a++) {
                ...
                if (l.length) {
                    for (l = 0; l < f.length; l++)
                        g = f[l],
                        (i = this.getPrevKeyWith(g, a, d)) && i.apply(g);
                    this.data.hierarchy[a].node.updateMatrix();
...
THREE.CubeGeometry = function(a, b, c, d, e, f) {
    function g(a, b, c, d, e, f, g, q) {
        ...
        for (e = 0; e < x; e++)
            for (f = 0; f < t; f++)
                a = new THREE.Face4(f + H * e + I,f + H * (e + 1) + I,f + 1 + H * (e + 1) + I,f + 1 + H * e + I),
                a.normal.copy(E),
                a.vertexNormals.push(E.clone(), E.clone(), E.clone(), E.clone()),
                a.materialIndex = q,
                i.faces.push(a),
                i.faceVertexUvs[0].push([new THREE.Vector2(f / t,1 - e / x), new THREE.Vector2(f / t,1 - (e + 1) / x), new THREE.Vector2((f + 1) / t,1 - (e + 1) / x), new THREE.Vector2((f + 1) / t,1 - e / x)])
    }
    THREE.Geometry.call(this);
    var i = this;
    this.width = a;
...
THREE.CylinderGeometry = function(a, b, c, d, e, f) {
    ...
    for (i = 0; i < d; i++) {
        ...
        n = this.vertices[k[0][i + 1]].clone()) : (m = this.vertices[k[1][i]].clone(),
    ...
    if (!f && 0 < a) {
        ...
        for (i = 0; i < d; i++)
            ...
            I = l[0][i].clone(),
            H = l[0][i + 1].clone(),
            D = new THREE.Vector2(H.u,0),
            this.faces.push(new THREE.Face3(r,p,q,[t, x, z])),
            this.faceVertexUvs[0].push([I, H, D])
    }
    if (!f && 0 < b) {
        this.vertices.push(new THREE.Vector3(0,-g,0));
        for (i = 0; i < d; i++)
...
THREE.ExtrudeGeometry.prototype.addShape = function(a, b) {
    ...
    if (p = !THREE.Shape.Utils.isClockWise(A)) {
        ...
        for (E = n.length; F < E; F++)
            y = n[F],
            THREE.Shape.Utils.isClockWise(y) && (n[F] = y.reverse());
        p = !1
    }
    ...
    for (J = 0; J < aa; J++)
        U = m ? c(A[J], M[J], K) : A[J],
        s ? (H.copy(v.normals[0]).multiplyScalar(U.x),
        I.copy(v.binormals[0]).multiplyScalar(U.y),
        D.copy(q[0]).add(H).add(I),
        f(D.x, D.y, D.z)) : f(U.x, U.y, 0);
    for (y = 1; y <= r; y++)
        for (J = 0; J < aa; J++)
            U = m ? c(A[J], M[J], K) : A[J],
            s ? (H.copy(v.normals[y]).multiplyScalar(U.x),
            I.copy(v.binormals[y]).multiplyScalar(U.y),
            D.copy(q[y]).add(H).add(I),
            f(D.x, D.y, D.z)) : f(U.x, U.y, i / r * y);
    for (B = l - 1; 0 <= B; B--) {
        y = B / l;
        L = h * (1 - y);
        K = k * Math.sin(y * Math.PI / 2);
        ...
        for (E = n.length; F < E; F++) {
            ...
            for (ha = y.length; J < ha; J++)
                U = c(y[J], Oa[J], K),
                s ? f(U.x, U.y + q[r - 1].y, q[r - 1].x + L) : f(U.x, U.y, i + L)
        }
    }
    if (m) {
        h = 0 * aa;
        for (J = 0; J < ba; J++)
            i = X[J],
            g(i[2] + h, i[1] + h, i[0] + h, !0);
        h = aa * (r + 2 * l);
        for (J = 0; J < ba; J++)
            i = X[J],
            g(i[0] + h, i[1] + h, i[2] + h, !1)
    } else {
        for (J = 0; J < ba; J++)
            i = X[J],
            g(i[2], i[1], i[0], !0);
        for (J = 0; J < ba; J++)
            i = X[J],
            g(i[0] + aa * r, i[1] + aa * r, i[2] + aa * r, !1)
    }
    i = 0;
    e(p, i);
    i += p.length;
...
THREE.ShapeGeometry.prototype.addShape = function(a, b) {
    ...
    for (e = 0; e < f; e++)
        ...
        g = k[1] + i,
        k = k[2] + i,
        this.faces.push(new THREE.Face3(h,g,k,null,null,c)),
        this.faceVertexUvs[0].push(d.generateBottomUV(this, a, b, h, g, k))
}
;
...
THREE.PlaneGeometry = function(a, b, c, d) {
    ...
    for (var c = a / 2, e = b / 2, d = this.widthSegments, f = this.heightSegments, g = d + 1, i = f + 1, h = this.width / d, k = this.height / f, l = new THREE.Vector3(0,0,1), a = 0; a < i; a++)
        for (b = 0; b < g; b++)
            this.vertices.push(new THREE.Vector3(b * h - c,-(a * k - e),0));
    for (a = 0; a < f; a++)
        for (b = 0; b < d; b++)
...
THREE.SphereGeometry = function(a, b, c, d, e, f, g) {
    ...
    for (var d = void 0 !== d ? d : 0, e = void 0 !== e ? e : 2 * Math.PI, f = void 0 !== f ? f : 0, g = void 0 !== g ? g : Math.PI, i = [], h = [], c = 0; c <= this.heightSegments; c++) {
        for (var k = [], l = [], b = 0; b <= this.widthSegments; b++) {
            ...
            r.y = this.radius * Math.cos(f + n * g);
    ...
    for (c = 0; c < this.heightSegments; c++)
        for (b = 0; b < this.widthSegments; b++) {
            ...
            this.faceVertexUvs[0].push([r, q, s])) : Math.abs(this.vertices[f].y) === this.radius ? (this.faces.push(new THREE.Face3(d,e,f,[k, l, m])),
            this.faceVertexUvs[0].push([r, p, q])) : (this.faces.push(new THREE.Face4(d,e,f,g,[k, l, m, n])),
            this.faceVertexUvs[0].push([r, p, q, s]))
        }
    this.computeCentroids();
    this.computeFaceNormals();
    this.boundingSphere = new THREE.Sphere(new THREE.Vector3,a)
...
THREE.TorusGeometry = function(a, b, c, d, e) {
    ...
    for (c = 0; c <= this.radialSegments; c++)
        for (d = 0; d <= this.tubularSegments; d++) {
            ...
            i.y = (this.radius + this.tube * Math.cos(g)) * Math.sin(f);
...
THREE.TubeGeometry = function(a, b, c, d, e, f) {
    ...
    for (b = 0; b < e; b++) {
        ...
        this.debug.add(new THREE.ArrowHelper(i,l,c,65280)));
        for (d = 0; d < this.radiusSegments; d++)
            h = 2 * (d / this.radiusSegments) * Math.PI,
...
THREE.TubeGeometry.FrenetFrames = function(a, b, c) {
    ...
    d.set(0, 1, 0));
    m <= a && d.set(0, 0, 1);
    i.crossVectors(e[0], d).normalize();
    f[0].crossVectors(e[0], i);
    g[0].crossVectors(e[0], f[0]);
    for (k = 1; k < b; k++)
        f[k] = f[k - 1].clone(),
        g[k] = g[k - 1].clone(),
        i.crossVectors(e[k - 1], e[k]),
        1E-4 < i.length() && (i.normalize(),
        d = Math.acos(e[k - 1].dot(e[k])),
        f[k].applyMatrix4(h.makeRotationAxis(i, d))),
    ...
    if (c) {
        ...
        for (k = 1; k < b; k++)
            f[k].applyMatrix4(h.makeRotationAxis(e[k], d * k)),
            g[k].crossVectors(e[k], f[k])
    }
}
;
THREE.PolyhedronGeometry = function(a, b, c, d) {
    ...
    function f(a, b, c, d) {
        ...
        h.faceVertexUvs[0].push([i(a.uv, a, d), i(b.uv, b, d), i(c.uv, c, d)])) : (d -= 1,
        f(a, g(a, b), g(a, c), d),
        f(g(a, b), b, g(b, c), d),
        f(g(a, c), g(b, c), c, d),
    ...
    THREE.Geometry.call(this);
    for (var c = c || 1, d = d || 0, h = this, k = 0, l = a.length; k < l; k++)
...
THREE.ParametricGeometry = function(a, b, c, d) {
    ...
    for (i = 0; i < c; i++)
        for (h = 0; h < b; h++)
            ...
            l = (i + 1) * m + h,
            k = (i + 1) * m + h + 1,
            n = new THREE.Vector2(h / b,i / c),
            r = new THREE.Vector2((h + 1) / b,i / c),
            p = new THREE.Vector2(h / b,(i + 1) / c),
            q = new THREE.Vector2((h + 1) / b,(i + 1) / c),
            d ? (f.push(new THREE.Face3(a,e,l)),
            f.push(new THREE.Face3(e,k,l)),
            g.push([n, r, p]),
            g.push([r, q, p])) : (f.push(new THREE.Face4(a,e,k,l)),
            g.push([n, r, q, p]));
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
...
THREE.ConvexGeometry = function(a) {
    ...
    for (d = 0; d < c.length; d++) {
        g = c[d];
        for (i = 0; 3 > i; i++)
            void 0 === f[g[i]] && (f[g[i]] = e++,
            this.vertices.push(a[g[i]])),
            g[i] = f[g[i]]
    }
    for (d = 0; d < c.length; d++)
...
THREE.MorphBlendMesh.prototype.autoCreateAnimations = function(a) {
    ...
    for (h in d)
        i = d[h],
        this.createAnimation(h, i.start, i.end, a);
...
THREE.LensFlarePlugin = function() {
    ...
    this.init = function(p) {
        ...
        r.opacity = b.getUniformLocation(m, "opacity");
    ...
    this.render = function(a, d, e, f) {
        ...
        if (x) {
            ...
            for (W = 0; W < x; W++)
                ...
                y.set(D * v, D),
                B = a[W],
                z.set(B.matrixWorld.elements[12], B.matrixWorld.elements[13], B.matrixWorld.elements[14]),
                z.applyMatrix4(d.matrixWorldInverse),
                z.applyProjection(d.projectionMatrix),
                F.copy(z),
                E.x = F.x * I + I,
                E.y = F.y * H + H,
                l || 0 < E.x && E.x < e && 0 < E.y && E.y < f) {
                    ...
                    b.enable(b.BLEND);
                    A = 0;
                    for (X = B.lensFlares.length; A < X; A++)
                        K = B.lensFlares[A],
                        0.001 < K.opacity && 0.001 < K.scale && (F.x = K.x,
                        F.y = K.y,
                        F.z = K.z,
                        D = K.size * K.scale / f,
                        y.x = D * v,
                        ...
                        b.uniform3f(G.screenPosition, F.x, F.y, F.z),
                        b.uniform2f(G.scale, y.x, y.y),
                        b.uniform1f(G.rotation, K.rotation),
                        b.uniform1f(G.opacity, K.opacity),
                        b.uniform3f(G.color, K.color.r, K.color.g, K.color.b),
...
THREE.ShadowMapPlugin = function() {
    ...
    this.update = function(l, m) {
            ...
            p.castShadow)
                if (p instanceof THREE.DirectionalLight && p.shadowCascade)
                    for (s = 0; s < p.shadowCascadeCount; s++) {
                        var H;
                        if (p.shadowCascadeArray[s])
                            H = p.shadowCascadeArray[s];
                        else {
                            v = p;
                            x = s;
        ...
        for (r = I.length; n < r; n++) {
            p = I[n];
            p.shadowMap || (s = THREE.LinearFilter,
            b.shadowMapType === THREE.PCFSoftShadowMap && (s = THREE.NearestFilter),
            ...
            if (p.isVirtual && H.originalCamera == m) {
                ...
                for (x = 0; 8 > x; x++)
                    z = v[x],
                    z.copy(t[x]),
                    THREE.ShadowMapPlugin.__projector.unprojectVector(z, s),
                    z.applyMatrix4(q.matrixWorldInverse),
                    z.x < h.x && (h.x = z.x),
                    z.x > k.x && (k.x = z.x),
                    z.y < h.y && (h.y = z.y),
                    z.y > k.y && (k.y = z.y),
            ...
            for (q = v.length; p < q; p++)
                ...
                t = x.object,
                x.render = !1,
                t.visible && t.castShadow && (!(t instanceof THREE.Mesh || t instanceof THREE.ParticleSystem) || !t.frustumCulled || g.intersectsObject(t)))
                    t._modelViewMatrix.multiplyMatrices(s.matrixWorldInverse, t.matrixWorld),
                    x.render = !0;
            p = 0;
            for (q = v.length; p < q; p++)
                x = v[p],
                ...
                z = 0 < t.geometry.morphTargets.length && D.morphTargets,
                D = t instanceof THREE.SkinnedMesh && D.skinning,
                z = t.customDepthMaterial ? t.customDepthMaterial : D ? z ? f : e : z ? d : c,
                x instanceof THREE.BufferGeometry ? b.renderBufferDirect(s, l.__lights, null, z, x, t) : b.renderBuffer(s, l.__lights, null, z, x, t));
            v = l.__webglObjectsImmediate;
            p = 0;
            for (q = v.length; p < q; p++)
                x = v[p],
                t = x.object,
                t.visible && t.castShadow && (t._modelViewMatrix.multiplyMatrices(s.matrixWorldInverse, t.matrixWorld),
                b.renderImmediateObject(s, l.__lights, null, c, t))
        }
        n = b.getClearColor();
        r = b.getClearAlpha();
...
THREE.SpritePlugin = function() {
    ...
    this.render = function(d, e, f, p) {
        ...
        if (s) {
            ...
            H instanceof THREE.Fog ? (b.uniform1f(x.fogNear, H.near),
            b.uniform1f(x.fogFar, H.far),
            b.uniform1i(x.fogType, 1),
            I = t = 1) : H instanceof THREE.FogExp2 && (b.uniform1f(x.fogDensity, H.density),
            b.uniform1i(x.fogType, 2),
            I = t = 2)) : (b.uniform1i(x.fogType, 0),
            I = t = 0);
            for (var D, y, F = [], H = 0; H < s; H++)
                D = q[H],
                y = D.material,
                D.visible && 0 !== y.opacity && (y.useScreenCoordinates ? D.z = -D.position.z : (D._modelViewMatrix.multiplyMatrices(e.matrixWorldInverse, D.matrixWorld),
                D.z = -D._modelViewMatrix.elements[14]));
            q.sort(a);
            for (H = 0; H < s; H++)
                D = q[H],
                y = D.material,
                D.visible && 0 !== y.opacity && (y.map && y.map.image && y.map.image.width) && (b.uniform1f(x.alphaTest, y.alphaTest),
                !0 === y.useScreenCoordinates ? (b.uniform1i(x.useScreenCoordinates, 1),
                b.uniform3f(x.screenPosition, (D.position.x * c.devicePixelRatio - f) / f, (v - D.position.y * c.devicePixelRatio) / v, Math.max(0, Math.min(1, D.position.z))),
                F[0] = c.devicePixelRatio,
                F[1] = c.devicePixelRatio) : (b.uniform1i(x.useScreenCoordinates, 0),
                b.uniform1i(x.sizeAttenuation, y.sizeAttenuation ? 1 : 0),
                b.uniformMatrix4fv(x.modelViewMatrix, !1, D._modelViewMatrix.elements),
                F[0] = 1,
                F[1] = 1),
                e = d.fog && y.fog ? I : 0,
                t !== e && (b.uniform1i(x.fogType, e),
                t = e),
                e = 1 / (y.scaleByViewport ? p : 1),
                F[0] *= e * z * D.scale.x,
                F[1] *= e * D.scale.y,
                b.uniform2f(x.uvScale, y.uvScale.x, y.uvScale.y),
                b.uniform2f(x.uvOffset, y.uvOffset.x, y.uvOffset.y),
                b.uniform2f(x.alignment, y.alignment.x, y.alignment.y),
                b.uniform1f(x.opacity, y.opacity),
                b.uniform3f(x.color, y.color.r, y.color.g, y.color.b),
                b.uniform1f(x.rotation, D.rotation),
                b.uniform2fv(x.scale, F),
...
THREE.DepthPassPlugin = function() {
    ...
    this.update = function(h, k) {
        ...
        for (m = q.length; l < m; l++)
            ...
            p = n.object,
            n.render = !1,
            p.visible && (!(p instanceof THREE.Mesh || p instanceof THREE.ParticleSystem) || !p.frustumCulled || g.intersectsObject(p)))
                p._modelViewMatrix.multiplyMatrices(k.matrixWorldInverse, p.matrixWorld),
                n.render = !0;
        var s;
        l = 0;
        for (m = q.length; l < m; l++)
            ...
            n.render && (p = n.object,
            n = n.buffer,
            !(p instanceof THREE.ParticleSystem) || p.customDepthMaterial))
                (s = p.material instanceof THREE.MeshFaceMaterial ? p.material.materials[0] : p.material) && b.setMaterialFaces(p.material),
                r = 0 < p.geometry.morphTargets.length && s.morphTargets,
                s = p instanceof THREE.SkinnedMesh && s.skinning,
                r = p.customDepthMaterial ? p.customDepthMaterial : s ? r ? f : e : r ? d : c,
                n instanceof THREE.BufferGeometry ? b.renderBufferDirect(k, h.__lights, null, r, n, p) : b.renderBuffer(k, h.__lights, null, r, n, p);
        q = h.__webglObjectsImmediate;
        l = 0;
        for (m = q.length; l < m; l++)
            n = q[l],
            p = n.object,
            p.visible && (p._modelViewMatrix.multiplyMatrices(k.matrixWorldInverse, p.matrixWorld),
            b.renderImmediateObject(k, h.__lights, null, c, p));
        l = b.getClearColor();
        m = b.getClearAlpha();
